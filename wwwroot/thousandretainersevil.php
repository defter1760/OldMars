...
$pdf->Ln();
$pdf->SetFont('Times','',12);
$pdf->MultiCell(0,5,'Enclosed: Retainer Agreement and self-addressed stamped envelope');
$code= $row['uniqueid'];
		  ...
		  <td width="20" bgcolor="#ffffff" >&nbsp;</td>
			<td bgcolor="#ffffff"><table width="100%" border="0"  cellpadding="14">
			  <tr>
				...
				<p>Please mail out the attached attorney client agreement today. <br /><br />
...
MARS: <a href="http://sqlsrv.domain.initiativelegal.com/mars/index.php?uniqueid='.$row['uniqueid'].'">CLICK HERE</a>
...
';	    
        ...
        $attachment2  = "/inetpub/wwwroot/thousandretainers/$date/$filename$ext";
...
# $mail->AddAddress('ihutchings@initiativelegal.com','Mass Action Mailroom');
  ...
  $mail->Subject = 'Attorney-Client Agreement! - '.$row['LastName'].', '.$row['FirstName'].' - '.$row['uniqueid'];
...
echo '<div id="message">';
    ...
    echo '<form action="thousandretainersevil.php" method="post">';    
echo '<h4>WARNING! EVIL BUTTON! DO NOT ABUSE!<br /><br />';

echo '<h4>Push button to email Mailroom 1000 retainer packets<br /><br />';
