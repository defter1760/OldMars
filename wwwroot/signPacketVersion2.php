...
echo '<div id="main">';
	echo '<div id="message">';
		echo '<ol>';
			echo '<li><p>Carefully review the following forms and verify the spelling of your full name at the top of each document.</p></li>';
		...
		echo "<table align='center' width='1024px'>";
			echo "<tr>";
				echo "<td height='1600px' valign='top' align='center'>";
					echo "<iframe valign='top' align='middle' marginheight='5%' width='99%' height='98%' src='";
