...
echo '<div id="message">';
    ...
    echo '<form action="thousandretainers.php" method="post">';    
...
$query = "
select TOP 10000 FirstName,LastName,uniqueid,Street1,Street2,City,State,Zipcode,retainerSent from Status where retainerSent='Docusign' and (retainerRecieved!='Docusigned' or retainerRecieved is null) and (donotcontact!='Yes' or donotcontact='' or donotcontact is null) and (notqualified!='Yes' or notqualified='' or notqualified is null) and uniqueid='SA4D5A8YPJAQRPN9Y' order by LastName";
