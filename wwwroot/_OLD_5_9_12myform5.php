  ...
  <div class="form-all">
    <ul class="form-section">
      ...
      <li class="form-line" id="id_3">
        ...
        <div id="cid_3" class="form-input"><span class="form-sub-label-container"><input class="form-textbox validate[required]" type="text" size="25" name="1WhoFirstName" id="first_3" />
            <label class="form-sub-label" for="first_3" id="sublabel_first"> First Name </label></span><span class="form-sub-label-container"><input class="form-textbox validate[required]" type="text" size="35" name="1WhoLastName" id="last_3" />
      ...
      <li class="form-line" id="id_5">
        ...
        <div id="cid_5" class="form-input"><!--<span class="form-sub-label-container"><input class="form-textbox validate[required]" type="tel" name="q5_phoneNumber5[area]" id="input_5_area" size="3">
            -
            <label class="form-sub-label" for="input_5_area" id="sublabel_area"> Area Code </label></span>--><span class="form-sub-label-container"><input class="form-textbox validate[required]" type="text" name="1CallbackNum" id="input_5_phone" pattern="[0-9]{10}" title="Ten digit phone number" size="12"/>
      ...
      <li class="form-line" id="id_6">
        ...
        <div id="cid_6" class="form-input"><!--<span class="form-sub-label-container"><input class="form-textbox" type="tel" name="q6_alternatePhone[area]" id="input_6_area" size="3">
            -
            <label class="form-sub-label" for="input_6_area" id="sublabel_area"> Area Code </label></span>--><span class="form-sub-label-container"><input class="form-textbox validate" type="text" name="3SecondaryNumber" id="input_5_phone" pattern="[0-9]{10}" title="Ten digit phone number" size="12"/>
      ...
      <li class="form-line" id="id_13">
        ...
        <div id="cid_13" class="form-input">
          ...
          <a class="addspeech" title="No problem. Please call our law firm at 1.888.792.2293, Monday through Friday 8:30 a.m. to 6:30 p.m., PST to discuss your potential claims."><span class="whatsthis">I don't have an email address.</span></a><br />
      ...
      <li class="form-line" id="id_4">
        ...
        <div id="cid_4" class="form-input">
          <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="2"><span class="form-sub-label-container"><input class="form-textbox validate form-address-line" type="text" name="3StreetLine2" id="input_4_addr_line1" />
            ...
            <tr>
              ...
              <td><span class="form-sub-label-container"><input class="form-textbox validate[required] form-address-city" type="text" name="3HomeState" id="input_4_city" size="21" />
      ...
      <li class="form-line" id="id_21">
        ...
        <div id="cid_21" class="form-input-wide">
          <div class="form-multiple-column"><span class="form-radio-item"><input type="radio" class="form-radio" id="input_21_0" name="didyouworkatmacysretail" value="Yes" />
      ...
      <li class="form-line" id="id_20">
        ...
        <div id="cid_20" class="form-input-wide">
          <div class="form-multiple-column"><span class="form-radio-item"><input type="radio" class="form-radio" id="input_20_0" name="q20_areYou" value="Yes" />
              <label for="input_20_0"> Yes </label></span><span class="clearfix"></span><span class="form-radio-item"><input type="radio" class="form-radio" id="input_20_1" name="q20_areYou" value="No" />
      ...
      <li class="form-line" id="id_15">
        ...
        <span class="form-sub-label-container">
            ...
            <select class="form-textbox" id="month_15" name="formerlastdayyear">
...
"><span class="whatsthis">What's this?</span>
      ...
      <li class="form-line" id="id_27">
        ...
        <div id="cid_27" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio" id="input_27_0" name="wantstoshare1" value="Yes" />
              <label for="input_27_0"> Yes </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio" id="input_27_1" name="wantstoshare1" value="No" />
