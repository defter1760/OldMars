...
<script type="text/javascript">
   JotForm.setConditions([{"action":{"field":"15","visibility":"Hide"},"link":"Any","terms":[{"field":"20","operator":"equals","value":"Yes"}],"type":"field"},{"action":{"field":"2","visibility":"Show"},"link":"Any","terms":[{"field":"16","operator":"isFilled","value":false},{"field":"23","operator":"isFilled","value":false}],"type":"field"},{"action":{"field":"17","visibility":"Show"},"link":"Any","terms":[{"field":"16","operator":"equals","value":"I wasn't paid for all the work I performed."}],"type":"field"},{"action":{"field":"23","visibility":"Hide"},"link":"Any","terms":[{"field":"16","operator":"isFilled","value":false}],"type":"field"},{"action":{"field":"16","visibility":"Hide"},"link":"Any","terms":[{"field":"23","operator":"isFilled","value":false}],"type":"field"}]);
...
<!--<script type="text/javascript">
   JotForm.setConditions(
			 [{"action":{"field":"15","visibility":"Hide"},"link":"Any",
			"terms":[{"field":"20","operator":"equals","value":"Yes"}],
			"type":"field"},{"type":"field","link":"Any","terms":[{"field":"16","operator":"isFilled","value":false},{"field":"23","operator":"isFilled","value":false}],"action":{"field":"2","visibility":"Show"}},
			{"action":{"field":"17","visibility":"Show"},"link":"Any","terms":[{"field":"16","operator":"equals","value":"I wasn't paid for all the work I performed."}],"type":"field"},
			{"action":{"field":"23","visibility":"Hide"},"link":"Any","terms":[{"field":"16","operator":"isFilled","value":false}],"type":"field"},
			{"action":{"field":"16","visibility":"Hide"},"link":"Any","terms":[{"field":"23","operator":"isFilled","value":false}],"type":"field"}]);
   JotForm.init(function(){
      $('input_13_confirm').hint('Confirm Email');
      $('input_13').hint('ex: myname@example.com');
      JotForm.setCalendar("15");
    ...
    <ul class="form-section">
      <li id="cid_11" class="form-input-wide">
        <div class="form-header-group">
          ...
          <p>We are investigating potential wage and hour claims against Macy's and would like to know if you have experience similar labor code violations.</p>
          </div>
      </li>
      ...
      <li class="form-line" id="id_5">
        ...
        <input class="form-textbox validate[required]" type="tel" name="q5_phoneNumber5[area]" id="input_5_area" size="3">
            ...
            <span class="form-sub-label-container">
            <input class="form-textbox validate[required]" type="tel" name="1CallbackNum" id="input_5_phone" size="25">
...
<!--        <span class="form-sub-label-container">
        <input class="form-textbox" type="tel" name="q6_alternatePhone[area]" id="input_6_area" size="3">
            ...
            <span class="form-sub-label-container">
            <input class="form-textbox" type="tel" name="3SecondaryNumber" id="input_6_phone" size="25">
      ...
      <li class="form-line" id="id_13">
        ...
        <div id="cid_13" class="form-input">
          ...
          <a class="addspeech" title="No problem.  Please contact one of our representatives at 888.792.2293, Monday through Friday 8:30 a.m. to 6:30 p.m., PLS to discuss your potential claims."><span class="whatsthis">I don't have an email address.</span></a><br />
      ...
      <li class="form-line" id="id_21">
        ...
        Did you work at a Macy's retail store? <span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_15">
        ...
        <span class="date-separate">&nbsp;/</span>
            ...
            <span class="form-sub-label-container">
            <img alt="Pick a Date" id="input_15_pick" src="https://jotform.us/images/calendar.png" align="absmiddle" />
      ...
      <li class="form-line" id="id_16">
        ...
        <div id="cid_16" class="form-input-wide">
          ...
          <span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_16_0" name="shortcheck1" value="I missed some or all of my meal breaks while I worked for Macys." />
              <label for="input_16_0"> I missed some of my meal breaks while I worked for Macy's.<a class="addspeech" title="With some exceptions, employers must provide hourly employees with at least a 30-minute uninterrupted meal break for every 5 hours worked and with two 30-minute uninterrupted meal breaks if the employee works more than 10 hours in one day."><span class="whatsthis">What's this?</span></a>  </label></span><span class="clearfix"></span><span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_16_1" name="shortcheck2" value="I missed some or all of my rest breaks while I worked for Macys." />
              ...
              <label for="input_16_3"> I wasn't paid for all my overtime work.<a class="addspeech" title="If an employee works more than 8 hours in a single day or more than 40 hours in a week, the employee is entitled to 1 and a half times their regular hourly rate for those hours worked after 8 hours in a single day and/or 40 hours in a week."><span class="whatsthis">What's this?</span></a> </label></span><span class="clearfix"></span><span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_16_4" name="shortcheck5" value="I am a former employee. When I left Macys, I was not given my final paycheck within 3 days." />
...
</a> </label></span><span class="clearfix"></span><!--<span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_16_6" name="shortcheck7" value="While working for Macys, I was not allowed to sit during my shift." />
              <label for="input_16_6"> While working for Macy's, I was not allowed to sit during my shift.<a class="addspeech" title="Employers must provide an adequate number of suitable seats to its employees when the employees are not engaged in the active duties of their employment and the nature of the work requires standing. "><span class="whatsthis">What's this?</span></a> </label></span>--><span class="clearfix"></span><span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_16_7" name="shortcheck8" value="I wasnt paid for all the work I did." />
              <label for="input_16_7"> I wasn't paid for all the work I did. </label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
     ...
     <li class="form-line" id="id_16_7">
        <label class="form-label-top" id="16_7" for="16_7">
          <div id="barcode">Postcard Barcode # (Optional) <a class="whatsthis" href="#" rel="imgtip[0]">What's this?</a></div>
        </label><br />
