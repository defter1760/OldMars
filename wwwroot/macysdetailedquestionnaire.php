...
Elina asked me to change DOCTYPE on 6/13/12 -- 9:53AM
-->
...
<form class="jotform-form" action="database_write_MacysFull.php" method="post" enctype="multipart/form-data" name="form_20599278470161" id="20599278470161" accept-charset="utf-8"> <?PHP #database_write_MacysFull.php ?><?PHP //posttest.php ?>
...
echo '<div id="main">';
echo '<div id="message">';
echo '<h1 style="color: #A23; font-size: 32px;line-height: 38px;padding: 10px 0;text-align: center;text-shadow: 1px 1px #777;">Step Four</h1>';
echo '<h4 style="font-size: 18px; line-height: 22px; color:#111; font-weight: bold; text-align: center; text-decoration: none;">Online Interview Regarding Your Potential Wage And Hour Claims Against Macy\'s</h4>';
#echo '<h3>ONLINE INTERVIEW REGARDING YOUR POTENTIAL WAGE AND HOUR CLAIMS AGAINST MACY\'S</h3>';
echo '<ul>';
echo '<li>The following questions are designed to provide us with more detailed information about your potential wage and hour claims against Macy\'s. Please complete all questions accurately and truthfully, to the best of your recollection. This interview should take between 15-20 minutes to complete. </li>';
echo "<li>";
echo "Please note that in order to complete the interview and have the information you entered saved, you will need to click the SUBMIT button at the end of the interview.</li>";
echo '</ul>';
      ...
      <li id="cid_1" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_1" class="form-subHeader">
            Contact Information (Interview Section 1 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
...
?>
            ...
            <label class="form-sub-label" for="input_4_phone" id="sublabel_phone"> Phone Number (Example xxx-xxx-xxxxx)</label></span>
        </div>
      </li>
...
?>
            ...
            <label class="form-sub-label" for="input_6_phone" id="sublabel_phone"> Phone Number (Example xxx-xxx-xxxxx)</label></span>
        </div>
      </li>
...
?>	      
            ...
            <option value="AK" <?PHP if ($HomeState == "AK") echo "selected"?>>AK</option>	
            ...
            <option value="MN" <?PHP if ($HomeState == "MN") echo "selected"?>>MN</option>	
            ...
            <option value="NE" <?PHP if ($HomeState == "NE") echo "selected"?>>NE</option>	
...
<!--          <div class="form-pagebreak-back-container form-label-left">
        ...
        <div class="clear"></div>
        <p class="privilege" style="font-size: 12px;text-align: center;text-decoration: underline;padding-top:10px;">CONFIDENTIAL/WORK PRODUCT PRIVILEGE</p>
      </li>
    </ul>
    <ul class="form-section" id="session2" style="display:none;"><a name="TOP2">&nbsp;</a>
      <li id="cid_16" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_16" class="form-subHeader">
            What is your employment background at Macy's?  (Interview Section 2 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
     <li class="form-line" id="id_97">
        ...
        <div id="cid_97" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" id="recentPosition1" name="recentPosition1"/>
             ...
             onclick="showPositionExplain();"/>
              ...
              <label for="input_97_11">I worked more than one position during my employment at Macy's.</label></span><span class="clearfix"></span>
                 <span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_97_13" name="recentPosition" value="Stockroom" onClick="showPositionExplain();"/>
              <label for="input_97_13">
	      Stockroom
	      </label>
		 </span>
		 <span class="clearfix">
      ...
      <li class="form-line" id="id_106" style="display:none;">
        <label class="form-label-top" id="label_106" for="input_99"> If you worked more than one position during your most recent employment with Macy's, please explain:</label>
      </li>
      ...
      <li class="form-line" id="id_300" style="display:none;">
        <div id="cid_300" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_99" class="form-textarea" name="recentPositionExplain" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_300-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>
...
<!--       <div id="cid_110" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_110" class="form-textarea" name="PaidHourly" cols="70" rows="6"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_100-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>-->
      </li>
...
<!--       <div id="cid_111" class="form-input-wide">
      ...
      <li class="form-line" id="id_130">
        ...
        <div id="cid_130" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
          id="input_130_0" name="ReceiveCommission" value="Yes" onClick="showReceiveCommExplain();" />
              <label for="input_130_0">Yes</label></span>
              <span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
              id="input_130_1" name="ReceiveCommission" value="No" onClick="showReceiveCommExplain();"/>
              <label for="input_130_1">No</label></span> 
          </div>
        </div>
      </li>
      <li class="form-line" id="id_131" style="display:none;">
        <label class="form-label-top" id="label_131" for="input_131">If Yes, please define commissions: </label>
          <div class="form-textarea-limit"><span><textarea id="input_131" class="form-textarea" name="ReceiveCommissionExplain" cols="70" rows="6" value=""></textarea>
        ...
        <div id="cid_132" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
          id="input_132_0" name="DeductCommission" value="Yes" onClick="showDeductCommExplain();" />
              <label for="input_132_0">Yes</label></span>
              <span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
              id="input_132_1" name="DeductCommission" value="No" onClick="showDeductCommExplain();"/>
              <label for="input_132_1">No</label></span> 
          </div>
        </div>
      </li>
      <li class="form-line" id="id_133" style="display:none;">
        <label class="form-label-top" id="label_133" for="input_133">If Yes, how much? Was it a certain percentage of the commission? The whole commission? Did it always vary? Please explain:</label>
          <div class="form-textarea-limit"><span><textarea id="input_133" class="form-textarea" name="DeductCommissionExplain" cols="70" rows="6"></textarea>
...
<!--            <li class="form-line" id="id_134">
        <label class="form-label-top" id="label_134" for="input_134">
         If you were not a commissioned employee, did Macy's ever deduct a portion of your paycheck for any reason other than for tax purposes?  For example, health benefit deductions, 401K deductions, or anything similar that you agreed to be deducted from your paycheck. <span class="form-required">*</span>
        </label>
        <div id="cid_134" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
          id="input_134_0" name="DeductPayCheck" value="Yes" onclick="showDeductCheckExplain();" />
              <label for="input_134_0">Yes</label></span>
              <span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" 
              id="input_134_1" name="DeductPayCheck" value="No" onclick="showDeductCheckExplain();"/>
              <label for="input_134_1">No</label></span> 
          </div>
        </div>
      </li>-->
      <li class="form-line" id="id_135" style="display:none;">
        <label class="form-label-top" id="label_135" for="input_135">If Yes, please explain: </label>
          <div class="form-textarea-limit"><span><textarea id="input_135" class="form-textarea" name="DeductPayCheckExplain" cols="70" rows="6"></textarea>
      ...
      <li class="form-line" id="id_20">
        <div id="cid_20" class="form-input-wide">
         ...
         <label class="form-label-top"> What are the dates of your most recent employment at Macy's?<span class="form-required">*</span></label>
          </div>
        </div>
      </li>
	...
	<span class="date-separate">&nbsp;/</span>
      ...
      <li class="form-line" id="id_104">
        ...
        <div class="form-textarea-limit"><span>
          <textarea id="input_104" class="form-textarea" id="identifypeople" name="identifypeople" cols="40" rows="6" value=""></textarea> <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_202-limit">(Maximum characters: 1000)</span>
        </div>
      </li>
      ...
      <li id="cid_23" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_23" class="form-subHeader">
            Were you not able to take meal breaks? (Interview Section 3 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
...
For each workday that an employer fails to provide an employee with a required 30-minute <u>uninterrupted</u> meal break, the employee is entitled to recover an additional hour of pay at the employee's regular rate.
      ...
      <li class="form-line" id="id_27">
        <label class="form-label-top" id="label_27" for="input_27">
         In your most recent position at Macy's, on average, how many hours was your typical shift? <span class="form-required">*</span>
        </label>
        <div id="cid_27" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" id="Category1"  
          name="Category1"/>
              ...
              <input type="radio" class="form-radio validate[required]" id="input_27_2" name="4Category" value="Between 8 hours to 10 hours" />
              <label for="input_27_2">Between 8 hours to 10 hours </label></span><span class="clearfix"></span>
              <span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_27_3" name="4Category" value="More than 10 hours" />
              <label for="input_27_3"> More than 10 hours</label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_28">
        ...
        <div id="cid_28" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
          	  <input type="radio" class="form-radio validate[required]" id="input_28_0" name="7Cat1MealBreakWaived" value="Yes, always" />
              <label for="input_28_0"> Yes, always</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
               <input type="radio" class="form-radio validate[required]" id="input_28_1" name="7Cat1MealBreakWaived" value="Yes, sometimes" />
              <label for="input_28_1"> Yes, sometimes</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_28_2" name="7Cat1MealBreakWaived" value="No, never"  />
              <label for="input_28_2"> No, never </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_28_3" name="7Cat1MealBreakWaived" value="I do not remember"/>
      ...
      <li class="form-line" id="id_30">
        <label class="form-label-top" id="label_30" for="input_30">
           In your most recent position at Macy's, how often were you NOT able to take an <u>uninterrupted</u> 30-minute meal break? (Check the one that best describes your situation.) <span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_31">
        <label class="form-label-top" id="label_31" for="input_31">
           In your most recent position at Macy's, in general, why did you NOT take meal breaks?<span class="form-required">*</span>
        </label>
        <div id="cid_31" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
          <input type="radio" class="form-radio validate[required]" id="input_31_0" name="7MealBreakMissedCat1Why" value="Employer demands"  onclick="whyMealBreakExplain();"/>
              <label for="input_31_0"> Employer demands (e.g., understaffed, not allowed by supervisor, too busy, too much work, helping customers, etc.)</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
      ...
      <li class="form-line" id="id_302" style="display:none;">
          ...
          <div class="form-textarea-limit"><span><textarea id="input_302" class="form-textarea" name="missMealBreakrExplain" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_302-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>        
      <li class="form-line" id="id_32">
        <label class="form-label-top" id="label_32" for="input_32">
          In your most recent position at Macy's, did you ever work shifts of more than 10 hours?<span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_33">
        <label class="form-label-top" id="label_33" for="input_33">
         In your most recent position at Macy's, were you ever NOT able to take 2 <u>uninterrupted</u> 30-minute meal breaks when you worked shifts of more than 10 hours?<span class="form-required">*</span>
        </label>
        <div id="cid_33" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_33_0" name="7Cat3DidGetSecondMealBreak" value="Yes, always" />
              ...
              <label for="input_33_2"> No </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_33_3" name="7Cat3DidGetSecondMealBreak" value="I do not remember" />
              <label for="input_33_3"> I don't remember </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_33_4" name="7Cat3DidGetSecondMealBreak" value="Not applicable, I never worked a shift that was 10 hours or longer in one day." />
              <label for="input_33_4">Not applicable, I never worked a shift that was 10 hours or longer in one day.</label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_34">
        ...
        <div id="cid_34" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_34_0" name="7Cat3Missed2ndMealBreakOften" value="Everyday" />
              ...
              <label for="input_34_4">Not applicable, I never worked a shift that was 10 hours or longer in one day.</label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_35">
        <label class="form-label-top" id="label_35" for="input_35">
        Did you receive an additional hour of pay on those occasions you were NOT able to take an <u>uninterrupted</u> 30-minute meal break?<span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_36">
        ...
        <div id="cid_36" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_36" class="form-textarea" name="session3Explain" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_36-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li> 
      ...
      <li id="cid_36" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_36" class="form-subHeader">
           Were you not able to take rest breaks? (Interview Section 4 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
...
With certain exceptions, California law also requires that employers allow employees to take at least a 10-minute <u>uninterrupted</u> rest break for every 4 hours worked. For each day an employer prevents, stops, or interrupts a required 10-minute rest break, the employee is entitled to recover an additional hour of pay at the employee's regular rate of pay.
      ...
      <li class="form-line" id="id_39">
        <label class="form-label-top" id="label_39" for="input_39">
             In your most recent position at Macy's, were you ever NOT able to take at least a 10-minute <u>uninterrupted</u> rest break for every 4 hours worked in a day?<span class="form-required">*</span>
        </label>
        <div id="cid_39" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" id="RestEverMissed1" name="RestEverMissed1"/>
      ...
      <li class="form-line" id="id_40">
        <label class="form-label-top" id="label_40" for="input_40">
         In your most recent position at Macy's, how often were you NOT able to take at least a 10-minute <u>uninterrupted</u> rest break after working 4 hours?<span class="form-required">*</span>
        </label>
        <div id="cid_40" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_40_0" name="8HowOftenMissRest" value="Everyday" />
              <label for="input_40_0"> Everyday </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
      ...
      <li class="form-line" id="id_41">
        <label class="form-label-top" id="label_41" for="input_41">
         In your most recent position at Macy's, why would you miss your rest breaks?<span class="form-required">*</span>
        </label>
       ...
       <li class="form-line" id="id_303" style="display:none;">
         <div id="cid_303" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_303" class="form-textarea" name="missRestBreakExplain" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_303-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>        
      <li class="form-line" id="id_42">
        ...
        <div id="cid_42" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_42_0" name="8ExtraHourPay" value="Yes, always" />
              ...
              <label for="input_42_2"> No </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_42_3" name="8ExtraHourPay" value="I do not remember" />
       ...
       <li class="form-line" id="id_203">
        ...
        <div id="cid_203" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_203" class="form-textarea" name="session4Explain" cols="70" rows="6"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_203-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li> 
      ...
      <li id="cid_43" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_43" class="form-subHeader">
            Were you compensated for off the clock work and overtime? (Interview Section 5 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
...
In your most recent position at Macy's, when you were leaving the store for a meal break or at the end of your shift, were you required to have your personal bag checked before you could leave? <span class="form-required">*</span>
        </label>
        <div id="cid_44" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" id="BagsChecksYesNo1" name="BagsChecksYesNo1"/>
      ...
      <li class="form-line" id="id_45">
        <label class="form-label-top" id="label_45" for="input_45">
           How often was your bag checked?<span class="form-required">*</span>
        </label>
    ...
    <select class="form-textbox" id="hour_109" name="bagCheckWaitHour"> 
      ...
      <li class="form-line" id="id_51">
        <label class="form-label-top" id="label_51" for="input_51">
          In your most recent position at Macy's, did you ever work the closing shift?<span class="form-required">*</span>
        </label>
       ...
       <li class="form-line" id="id_52">
        ...
        <div id="cid_52" class="form-input-wide">
          ...
          <label for="input_52_0">Yes, I had to wait for my co-workers before I could leave.</label></span>
          ...
          <span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
           ...
           <label for="input_52_3">No </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
            <input type="radio" class="form-radio validate[required]" id="input_52_4" name="9BagsCheckedEverytimeWaitToLeaving" value="Not applicable, I never worked the closing shift." onClick="waitToLeave();"/>
           <label for="input_52_4">Not applicable, I never worked the closing shift.</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          </div>
        </div>
      </li> 
      ...
      <label class="form-sub-label" for="minute_110" id="sublabel_generalWaitMinute">Minute</label>       
        ...
        In your most recent position at Macy's, did you ever perform work-related tasks before clocking-in or after clocking-out for which you believe you were not paid?<span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_121" style="display:none;">
        ...
        <div id="cid_121" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_121" class="form-textarea" name="afterBeforeClockExplain" cols="70" rows="6" value =""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_121-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_57">
        <label class="form-label-top" id="label_57" for="input_57">
         On average, how much time a week would you perform work-related tasks while you were off the clock? <span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_200">
        ...
        <div id="cid_200" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_200" class="form-textarea" name="session5Explain" cols="70" rows="6"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_200-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li> 
    ...
    <ul class="form-section" id="session6" style="display:none;"><a name="TOP6">&nbsp;</a>
      <li id="cid_59" class="form-input-wide">
        <div class="form-header-group">
         ...
         Were you paid all of your final wages? (Interview Section 6 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
        ...
        <div id="cid_304" class="form-input-wide">
          <div id="text_304" class="form-html">
            <p>
If you are a current employee, please skip the following seven questions and go to the next section by clicking the NEXT button at the bottom of this section. If you are a former employee, please answer the following seven questions in the section below.
            </p>
          </div>
        </div>
      </li>
...
Under California law, all wages due must be paid at the time of termination of employment, unless the employee quits without giving at least 72 hours notice, in which case the employer must pay the employee's final wages within 72 hours of quitting.   If the employee provides 72 hours notice prior to quitting, all wages due must be paid on the employee's last day of work.
      ...
      <li class="form-line" id="id_63">
        ...
        In your most recent position at Macy's, were you terminated (laid-off or fired) or did you quit your employment?<span class="form-required">*</span>
        </label>
      ...
      <li class="form-line" id="id_68">
        ...
        <div id="cid_68" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
           <input type="radio" class="form-radio validate[required]" id="input_68_6" name="12HowLongAfterTermRecieveCheckGreaterThan72" value="I received my final paycheck on my last day of work." />
              <label for="input_68_6">I received my final paycheck on my last day of work.</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;"><input type="radio" class="form-radio validate[required]" id="input_68_5" name="12HowLongAfterTermRecieveCheckGreaterThan72" value="Less than 4 days" />
              <label for="input_68_5">Less than 4 days </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio validate[required]" id="input_68_0" name="12HowLongAfterTermRecieveCheckGreaterThan72" 
              value="Between 4 and 7 days" />
      ...
      <li class="form-line" id="id_95">
        <label class="form-label-top" id="label_95" for="input_95">In your most recent position at Macy's, did your final paycheck include all commissions owed to you?</label>
      ...
      <li class="form-line" id="id_96">
        ...
        <div id="cid_96" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
              ...
              <label for="input_96_7"> I received all commissions owed to me on my last day of work. </label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
       <li class="form-line" id="id_201">
        ...
        <div id="cid_201" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_201" class="form-textarea" name="session6Explain" cols="70" rows="6"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_201-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li
    ...
    <ul class="form-section" id="session7" style="display:none;"><a name="TOP7">&nbsp;</a>
      <li id="cid_70" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_70" class="form-subHeader">
            Were you provided with a seat during your work shift? (Interview Section 7 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
      
      		<li class="form-line" id="id_171">
                    <label class="form-label-top" id="label_171" for="input_171">
                    ...
                    <div id="cid_71" class="form-input-wide">
                        <div class="form-single-column">
                            <span class="form-radio-item" style="clear:left; display: block;">
                                ...
                                value="Yes" />
                                <label for="input_171_0">Yes</label>
                            </span>
                            <span class="clearfix"></span>
                            <span class="form-radio-item" style="clear:left; display: block;">
                                <input type="radio" class="form-radio validate[required]" name="CashierEver" 
                                value="No" />
                                <label for="input_171_1">No</label>
                            </span>
      ...
      <li class="form-line" id="id_71">
        ...
        <div id="cid_71" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" id="DidYourJobRequireStanding1" name="DidYourJobRequireStanding1"/>
          ...
          value="Yes, and I was provided with a seat near my work station, other than a seat in the break room." />
           ...
           <input type="radio" class="form-radio validate[required]" id="input_71_3" name="14DidYourJobRequireStanding" value="I do not remember" />
      ...
      <li class="form-line" id="id_72">
        <label class="form-label-top" id="label_72" for="input_72">
          When you weren't engaged in your work duties, did Macy's ever let you sit in a seat during your work shift? <span class="form-required">*</span>
        </label>
       ...
       <li class="form-line" id="id_107" style="display:none;">
        ...
        <div id="cid_107" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_107" class="form-textarea" name="jobListSeated" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_107-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_76">
        ...
        <div id="cid_122" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_122" class="form-textarea" name="jobSeatedExplain" cols="70" rows="6" value=""></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_122-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_202">
        ...
        <div id="cid_202" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_202" class="form-textarea" name="session7Explain" cols="70" rows="6"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_202-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
      </li> 
      ...
      <li id="cid_87" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_87" class="form-subHeader">
            Do you have any documents from your most recent position at Macy's?<br /> (Interview Section 8 of 9)
          </h2>
        </div>
      </li>
      <li class="form-line" id="id_78">
        <div id="cid_78" class="form-input-wide">
          ...
          <!--<h3>CONFIDENTIAL ATTORNEY-CLIENT PRIVILEGED COMMUNICATION</h3>-->
            <p class="doc">To further assist us in pursuing your potential wage and hour claims against Macy's, you may provide us with documents from your employment.  You can send us your documents in one of four ways:
            </p>
       
                <p><span class="number">1.</span>  You can upload your documents directly from your computer:</p>
                <ul id="docs">
			...
			<?PHP
				...
				iframemake('https://DFWMS01.initiativelegal.com/mars/pubdocs.php',$uniqueid,'150px','pubdocs','0')
            ?>
      			</li>
                </ul>       
                
                
                <p><span class="number">2.</span>  You can scan and e-mail your documents to: <a href="mailto:MacysLawsuit@InitiativeLegal.com">MacysLawsuit@InitiativeLegal.com</a></p>
                <p><span class="number">3.</span>  You can fax your documents to:  (310) 734 - 1665</p>
            	<p><span class="number">4.</span>  You can mail your documents to: </p>
                	<ul id="address">
      ...
      <li id="cid_98" class="form-input-wide">
        <div class="form-header-group">
          <h2 id="header_98" class="form-subHeader">
           Do you qualify for a fee waiver? (Interview Section 9 of 9)<br /><span class="requiredRed">*Indicates a required field.</span>
          </h2>
        </div>
      </li>
      <li class="form-line" id="id_101">
        <div id="cid_101" class="form-input-wide">
          <div id="text_101" class="form-html">
            <p>
If our law firm elects to pursue your claims on an individual basis through arbitration, you may be entitled to a waiver of the associated cost with filing your case in an arbitration based upon your household size and current gross monthly income.
                  </p>
                  <p>
...
<!--              <input type="radio" class="form-radio" id="input_102_9" name="HouseHoldCount" value="More than 8" />
              <label for="input_102_9">More than 8 </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">-->
      ...
      <li class="form-line" id="id_103">
        ...
        <div id="cid_103" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_103_1" name="GrossIncome" value="2793to3783" />
              ...
              <input type="radio" class="form-radio" id="input_103_2" name="GrossIncome" value="3783to4773" />
              ...
              <input type="radio" class="form-radio" id="input_103_3" name="GrossIncome" value="4773to5763" />
              ...
              <input type="radio" class="form-radio" id="input_103_4" name="GrossIncome" value="5763to6753" />
              ...
              <input type="radio" class="form-radio" id="input_103_5" name="GrossIncome" value="6753to7743" />
              ...
              <input type="radio" class="form-radio" id="input_103_6" name="GrossIncome" value="7743to8733" />
              ...
              <label for="input_103_7"> Between $8,733- $9,723 </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">  <!--          <input type="radio" class="form-radio" id="input_103_9" name="GrossIncome" value="More than 9723" />
              <label for="input_103_9">More than $9,723 </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;"> -->
              <input type="radio" class="form-radio" id="input_103_8" name="GrossIncome" value="Decline" />
      ...
      <li id="cid_105" class="form-input-wide">
        <div class="form-pagebreak">
          ...
          <div class="form-pagebreak-next-container">
            <button type="button" class="form-pagebreak-next  form-submit-button-push_red" id="form-pagebreak-next_105" onClick="showDiv10();">
              Next
            </button>
    ...
    <ul class="form-section" id="session10" style="display:none;"><a name="TOP10">&nbsp;</a>
      ...
      <li class="form-line" id="id_2" style="float: right; padding: 0px !important;">
...
<?PHP
			if ($completedlongformonline == 'Yes')
			...
			else
				{
					...
					echo "In order to complete the interview, please click on the SUBMIT button below.<br /><br />";
					...
					echo '<br /><p class ="disclaimer">Disclaimer: Initiative Legal Group APC does not make any promises or guarantees as to any specific outcome of any case.</p>';
				}
