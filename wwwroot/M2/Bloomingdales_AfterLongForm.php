...
$connectionInfo = array( "Database"=>"Mars2", "UID"=>"SpiceWriter2012", "PWD"=>"p1c3righttwoohonetwo");
$conn = sqlsrv_connect( $serverName, $connectionInfo );
$query = "SELECT authformreceived,retainerRecieved,feewaiverreceived,completedlongformonline,FirstName,LastName,brand,email,brandid ,brand,Street1,Street2,City,Zipcode,State FROM Status WHERE uniqueid='$uniqueid'";
...
//Longformwriteropenfield($_POST['ReceiveCommission'],'ReceiveCommission',$uniqueid);	
//Longformwriteropenfield($_POST['ReceiveCommissionExplain'],'ReceiveCommissionExplain',$uniqueid);	
//Longformwriteropenfield($_POST['DeductCommission'],'DeductCommission',$uniqueid);	
//Longformwriteropenfield($_POST['DeductCommissionExplain'],'DeductCommissionExplain',$uniqueid);	
//Longformwriteropenfield($_POST['DeductPayCheck'],'DeductPayCheck',$uniqueid);	
//Longformwriteropenfield($_POST['DeductPayCheckExplain'],'DeductPayCheckExplain',$uniqueid);
...
//Longformwriteropenfield($_POST['CashierEver'],'CashierEver',$uniqueid);	
...
if ($GrossIncome == 'Between $2,793-$3,782') $grossincomeprint = 'between $2,793 and $3,783';
if ($GrossIncome == 'Between $3,783-$4,772') $grossincomeprint = 'between $3,783 and $4,773';
if ($GrossIncome == 'Between $4,773- $5,762') $grossincomeprint = 'between $4,773 and $5,763';
if ($GrossIncome == 'Between $5,763- $6,752') $grossincomeprint = 'between $5,763 and $6,753';
if ($GrossIncome == 'Between $6,753- $7,742') $grossincomeprint = 'between $6,753 and $7,743';
if ($GrossIncome == 'Between $7,743- $8,732') $grossincomeprint = 'between $7,743 and $8,733';
if ($GrossIncome == 'Between $8,733- $9,723') $grossincomeprint = 'between $8,733 and $9,723';
...
{
if ($HouseHoldCount == '1') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';

if ($HouseHoldCount == '2') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '2') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';

if ($HouseHoldCount == '3') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '3') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '3') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';

if ($HouseHoldCount == '4') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '4') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '4') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '4') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';

if ($HouseHoldCount == '5') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '5') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '5') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '5') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '5') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';

if ($HouseHoldCount == '6') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '6') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '6') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '6') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '6') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';
if ($HouseHoldCount == '6') if ($GrossIncome == 'Between $6,753- $7,742') $feewaivequal = 'Yes';

if ($HouseHoldCount == '7') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $6,753- $7,742') $feewaivequal = 'Yes';
if ($HouseHoldCount == '7') if ($GrossIncome == 'Between $7,743- $8,732') $feewaivequal = 'Yes';

if ($HouseHoldCount == '8') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $6,753- $7,742') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $7,743- $8,732') $feewaivequal = 'Yes';
if ($HouseHoldCount == '8') if ($GrossIncome == 'Between $8,733- $9,723') $feewaivequal = 'Yes';

if ($HouseHoldCount == '9') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $6,753- $7,742') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $7,743- $8,732') $feewaivequal = 'Yes';
if ($HouseHoldCount == '9') if ($GrossIncome == 'Between $8,733- $9,723') $feewaivequal = 'Yes';
#if ($HouseHoldCount == '9') if ($GrossIncome == '9723to10713') $feewaivequal = 'Yes';


if ($HouseHoldCount == '10') if ($GrossIncome == 'Less than $2,793') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $2,793-$3,782') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $3,783-$4,772') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $4,773- $5,762') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $5,763- $6,752') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $6,753- $7,742') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $7,743- $8,732') $feewaivequal = 'Yes';
if ($HouseHoldCount == '10') if ($GrossIncome == 'Between $8,733- $9,723') $feewaivequal = 'Yes';
...
$ext = ".pdf";
$pdf->Output("/inetpub/wwwroot/".$filename2."".$ext,"F"); //pushes file to server for temp storage
$pdf->Output("/inetpub/wwwroot/M2/Retainerstmp/".$filename2."".$ext,"F"); //pushes file to server for temp storage
//pdf create end
//FTP
$ftp_server = '10.129.3.21';
$ftp_user_name = 'sqlsrv';
