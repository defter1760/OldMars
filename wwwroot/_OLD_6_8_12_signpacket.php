...
#        $pdf->Ln();
	...
	$dir='/inetpub/wwwroot/';
	$filename = "$LastName, " .  "$FirstName" . " - ".$enclosurefilename." - Packet - ".$uniqueid; 
	$ext = ".pdf";
        
	$pdf->Output("/inetpub/wwwroot/$filename$ext","F",$uniqueid,$feewaiverpagenumber); //pushes file to server for temp storage
	$pdf->Output("/inetpub/wwwroot/Retainerstmp/$filename$ext","F",$uniqueid,$feewaiverpagenumber);
...
echo "<br><br><Br>";
echo $chewypdf."<br>".$pdfname."<br>".$pdfname."<br>".$uniqueid."<br>".$brandid."<br>".$brand."<br>".$tenantid."<br>".$FirstName."<br>".$LastName."<br>".$email."<br>".$RecipientName2."<br>".$RecipientEmail2;
echo "<br><br><Br>";
...
echo "'Ello Govna-- Come to sign a packet have ya??"
?>
