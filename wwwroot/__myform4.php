...
.form-submit-button{
	...
	border:none !important;
	text-indent:-99999px;
	background:url(http://www.yourlawsuit.com/macys/wp-content/uploads/2012/02/submit_red-e1331544035642.png) no-repeat 0 0;
	padding:0;
	margin:0;
}
    ...
    <ul class="form-section">
      <li id="cid_11" class="form-input-wide">
        <div class="form-header-group">
          <h1 id="header_11" class="HeaderRed"><div align="center">
Investigation of Macy's for potential labor violations<br /><br />Online questionnaire</div>
      ...
      <li id="cid_9" class="form-input-wide">
          ...
          <h2 id="header_8" class="form-subHeader">
            Tell us about Yourself:<div class="requiredRed">* Indicates a required field.
</div>
          </h2>
      </li>
...
<input class="form-textbox validate[required]" type="tel" name="1CallbackNumArea" id="input_5_area" pattern="[0-9]{3}" title="Three digit area code" size="3">
-
...
<span class="form-sub-label-container">
<input class="form-textbox validate[required]" type="tel" name="1CallbackNum" id="input_5_phone" pattern="[0-9]{7}" title="Seven digit phone number" size="8">
...
<span class="form-sub-label-container">
<input class="form-textbox" type="tel" name="3SecondaryNumArea" id="input_6_area" pattern="[0-9]{3}" title="Three digit area code" size="3">
            -
...
<span class="form-sub-label-container">
<input class="form-textbox" type="tel" name="3SecondaryNumber" id="input_6_phone" pattern="[0-9]{7}" title="Seven digit phone number" size="8">
...
<input type="email" class="form-textbox validate[required, Email]" id="input_13" name="3Email" size="30" />
	<a class="addspeech" title="No problem. Please contact one of our representatives at 888.792.2293, Monday through Friday 8:30 a.m. to 6:30 p.m., PST to discuss your potential claims."><span class="whatsthis">I don't have an email address.</span></a><br>
...
Did you work at Macy's?<span class="form-required">*</span>
</label>
