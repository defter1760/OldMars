	...
	if ( $showadvanced == "Yes" ) 
{
	...
	echo "<table border='0' bordercolor='#000000' style='background-color:#FFFFFF' width='560' cellpadding='2' cellspacing='0'>
  <tr>
  <th WIDTH='140' align='left'><font size=2><pre><strong>Interview Started:</strong></pre></th>
  <th WIDTH='140' align='left'><font size=2><pre><strong>Completed interview:</strong></pre></th>
  <th WIDTH='140' align='left'><font size=2><pre><strong>Completed Online:</strong></pre></th>
  <th WIDTH='140' align='left'><font size=2><pre><strong>Retainer Sent:</strong></pre></th>
  </tr>";

	echo "<tr>";
	echo "<td class='SmallFont' align='left'>";
		if (isset($interviewstarted)) 
	{
		if ( $interviewstarted == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='interviewstarted'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='interviewstarted'  value= 'Yes' > Yes ";
		}
		if ( $interviewstarted == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='interviewstarted'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='interviewstarted'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='interviewstarted'  value= '' > Clear";

	echo "</td>";
	echo "<td class='SmallFont' align='left'>";
			if (isset($reachedretainerdiscussion)) 
	{
		if ( $reachedretainerdiscussion == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='reachedretainerdiscussion'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='reachedretainerdiscussion'  value= 'Yes' > Yes ";
		}
		if ( $reachedretainerdiscussion == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='reachedretainerdiscussion'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='reachedretainerdiscussion'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='reachedretainerdiscussion'  value= '' > Clear";

	echo "</td>";
		echo "<td class='SmallFont' align='left'>";
 		if (isset($completedonline)) 
	{
		if ( $completedonline == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='completedonline'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='completedonline'  value= 'Yes' > Yes ";
		}
		if ( $completedonline == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='completedonline'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='completedonline'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='completedonline'  value= '' > Clear";
...
if (isset($retainerSent)) 
	{
		if ( $retainerSent == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerSent'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerSent'  value= 'Yes' > Yes ";
		}
		if ( $retainerSent == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerSent'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerSent'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='retainerSent'  value= '' > Clear";
echo "<tr>";
  echo "<th align='left'><font size=2><pre><strong>Retainer Received:</strong></pre></th>";
  echo "<th align='left'><font size=2><pre><strong>Authorization Received:</strong></pre></th>";
  echo "<th align='left'><font size=2><pre><strong>Demand Created:</strong></pre></th>";
  echo "<th align='left'><font size=2><pre><strong>Sent Retainer Countersign:</strong></pre></th>";
  echo "</tr>"; 
		...
		if (isset($retainerRecieved)) 
	{
		...
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerRecieved'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerRecieved'  value= 'Yes' > Yes ";
		}
		if ( $retainerRecieved == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerRecieved'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainerRecieved'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='retainerRecieved'  value= '' > Clear";
	echo "</td>";
			...
			if (isset($authformreceived)) 
	{
		...
		{
			echo "<INPUT TYPE = 'Radio' Name ='authformreceived'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='authformreceived'  value= 'Yes' > Yes ";
		}
		if ( $authformreceived == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='authformreceived'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='authformreceived'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='authformreceived'  value= '' > Clear";

	echo "</td>";
	
	echo "<td class='SmallFont' align='left'>";
		
		if (isset($demandcreated)) 
	{
		if ( $demandcreated == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='demandcreated'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='demandcreated'  value= 'Yes' > Yes ";
		}
		if ( $demandcreated == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='demandcreated'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='demandcreated'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='demandcreated'  value= '' > Clear";

	echo "</td>";
	
		echo "<td class='SmallFont' align='left'>";
		
		if (isset($retainercountersignsent)) 
	{
		if ( $retainercountersignsent == "Yes" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainercountersignsent'  value= 'Yes' checked> Yes ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainercountersignsent'  value= 'Yes' > Yes ";
		}
		if ( $retainercountersignsent == "No" ) 
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainercountersignsent'  value= 'No' checked> No ";
		}
		else
		{
			echo "<INPUT TYPE = 'Radio' Name ='retainercountersignsent'  value= 'No' > No ";
		}
	}
	else
	{
...
echo "<INPUT TYPE = 'Radio' Name ='retainercountersignsent'  value= '' > Clear";
...
echo "</table>";
	...
	echo " Retainer Status:		";
		...
		echo "<select name='retainerstatus'>";
			...
			if (isset($retainerstatus)) 
	{
		if ( $retainerstatus == "Received SIGNED" ) 
		{
			echo "<option > </option>";
			echo "<option value='Received SIGNED' selected='selected'>Received SIGNED</option>";
		}
		else
		{
			echo "<option> </option>";
			echo "<option value='Received SIGNED'>Received SIGNED</option>";
		}
		if ( $retainerstatus == "Received NEEDSATTN" ) 
		{
			echo "<option value='Received NEEDSATTN' selected='selected'>Received NEEDSATTN</option>";
		}
		else
		{
			echo "<option value='Received NEEDSATTN'>Received NEEDSATTN</option>";
		}
	}
	else
	{
	...
	echo "</select>";
	echo " Retainer Note:		";
	echo "<INPUT TYPE = 'text' Name='retainernote' value='$retainernote' style='width:50px; height:20px'>";
	echo " Authorization Note:		";
	echo "<INPUT TYPE = 'text' Name='authnote' value='$authnote' style='width:50px; height:20px'>";

}
	echo "<br><INPUT TYPE = 'Submit' Name = 'Submit1'  VALUE = 'Search'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "Show log:";
...

{
	if (empty($searchnote))
	{
		...
		$query = "SELECT * FROM status where $search $sort";
    	$results = sqlsrv_query($conn,$query);
	}
	...
	if (isset($searchnote))
	{
	$query = "SELECT * FROM status where $searchnote $sort";
    $results = sqlsrv_query($conn,$query);
	}
}
...
if (isset($sortstring))
{
	if (empty($searchnote))
	{
		...
		$query = "SELECT * FROM status where $search $sorstring";
    	$results = sqlsrv_query($conn,$query);
	}
	...
	if (isset($searchnote))
	{
	$query = "SELECT * FROM status where $searchnote $sorstring";
    $results = sqlsrv_query($conn,$query);
	}
}
...
echo "<table border='1' bordercolor='#000000' style='background-color:#FFFF99' width='100%' cellpadding='2' cellspacing='0'>";
	echo "<form action='Search.php?brandname=$brandname&agentlname=$agentlname' method='post'>";
