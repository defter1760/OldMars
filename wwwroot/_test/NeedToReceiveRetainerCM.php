...
?>
Retainers Sent and not returned:<br />

<?PHP 
    echo "<FORM NAME ='form2' METHOD ='POST' ACTION='NeedToReceiveRetainerCM.php'>";
...
if ($showcalllog == 'Yes')
{
 echo "<table border='1' bordercolor='#000000' style='background-color:#FFFF99' width='100%' cellpadding='2' cellspacing='0'>"; 
  ...
  echo "<tr>";
  echo "<td>";
    echo "Add interaction: <form action='NeedToReceiveRetainerCM.php?brandname=$brandname&agentlname=$agentlname' method='post'>";
