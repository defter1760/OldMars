    ...
    <ul class="form-section">
      <li id="cid_11" class="form-input-wide">
        <div class="form-header-group">
          <h1 id="header_11" class="HeaderRed">
            ...
            <p>We are investigating potential wage and hour claims against Macy's and would like to know if you experienced any labor code violations.</p>
      ...
      <li class="form-line" id="id_5">
        ...
        <input class="form-textbox validate[required]" type="tel" name="q5_phoneNumber5[area]" id="input_5_area" size="3">
            ...
            <span class="form-sub-label-container"><input class="form-textbox validate[required]" type="tel" name="1CallBackNum" id="input_5_phone" size="12">
	  ...
	  <a class="addspeech" title="No problem.  Please contact one of our representatives at 888.792.2293, Monday through Friday 8:30 a.m. to 6:30 p.m., PST to discuss your potential claims."><span class="whatsthis">I don't have an email address.</span></a>
          <br />
      ...
      <li class="form-line" id="id_21">
        <label class="form-label-top" id="label_21" for="input_21"> Did you work at a Macy's retail store?<span class="form-required">*</span></label>
...
"><span class="whatsthis">What's this?</span>
              ...
              <label for="input_16_5"> I was fired from Macy's and was not given my final paycheck on my last day of work.<a class="addspeech" title="California requires employers to provide final wages to employees within 3 days of their last day of work, or the employer has to pay a penalty."><span class="whatsthis">What's this?</span>
      ...
      <li class="form-line" id="id_23">
        ...
        <div id="cid_23" class="form-input-wide">
          <div class="form-single-column"><span class="form-checkbox-item" style="clear:left;"><input type="checkbox" class="form-checkbox" id="input_23_0" name="q23_23[]" value="None of the above apply to my work experience at Macy's" />
     ...
     <li class="form-line" id="id_16_7">
        <label class="form-label-top" id="16_7" for="16_7">
          <div id="barcode">Postcard Barcode # (Optional) <a class="whatsthis" href="https://macyslawsuit.com/questionnaire/" rel="imgtip[0]">What's this?</a></div>
        </label><br />
...
<p class="disclaimer">
Disclaimer: Initiative Legal Group APC does not make any promises or guarantees as to the outcome of any case
</p>