...
<form class="jotform-form" action="database_write_newprospect_Macys.php" method="post" name="form_20545014055139" id="20545014055139" accept-charset="utf-8">
...
<input type="email" class="form-textbox validate[Email]" id="input_13" name="3Email" size="30" />
	<br>
