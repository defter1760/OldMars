...
<?php $sid = md5(uniqid(rand())); //unique file id ?>
 ...
 <?PHP echo 'action="upload_retainer.php?uniqueid='.$uniqueid.'">'; ?>
  ...
  <p><label for="filename"><?php echo $lang['renameto'] ?> :</label><input type="text" id="filename" name="filename" onkeyup="filetypeCheck();" <?php echo 'value="'.$LastName.', '.$FirstName.' - Retainer Received - '.$dateNOW.' - '.$uniqueid.'.pdf"' ?> size="50" /></p>
