...
if (empty($files)){
	...
	foreach ($files as $file) {
		...
		echo '&nbsp;';
		if ($file['ext']!="directory") echo '<a href="?uniqueid='.$uniqueid.'&download='.urlencode($file['file']).'"><img src="'.rooturl().'images/download_arrow.gif" alt="('.$lang['download'].')" title="'.$lang['download_link'].'" /></a></td>';
