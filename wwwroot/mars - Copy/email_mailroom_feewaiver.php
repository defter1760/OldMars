...
$query = "IF EXISTS (SELECT * from status WHERE uniqueid='$uniqueid') UPDATE status set feewaivertomailroom='Yes',feewaivertomailroomdate='$dateNOW' WHERE status.uniqueid='$uniqueid'";
