...
function uploadfile($file,$uniqueid) {
	...
	if  ($errormsg=="") {
		...
		#$loc = rooturl();
		$loc = rooturl().'pubdocs.php?uniqueid='.$uniqueid;
...
function rooturl(){
	...
	return "https://".$_SERVER['HTTP_HOST'].$dir;
}
...
<?php $sid = md5(uniqid(rand())); //unique file id ?>
 ...
 <?PHP echo 'action="pubdocs.php?uniqueid='.$uniqueid.'">'; ?>
