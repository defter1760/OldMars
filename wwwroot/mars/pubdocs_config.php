...
#$samurai = "\\\\10.129.3.21\\MassAction\\Macys\\".$LastName.", ".$FirstName." - ".$uniqueid."";
#$sumo = "\\\\FILES\\MassAction\\Macys\\".$LastName.", ".$FirstName." - ".$uniqueid."";
$samurai = "\\\\10.129.3.21\\MassAction\\Macys\\".$uniqueid."";
$sumo = "\\\\FILES\\MassAction\\Macys\\".$uniqueid."";
$bob = urlencode($samurai);
$bob = urldecode($bob);
// --- basic ---
// title of your w2box
$config['w2box_title'] = $sumo;
// path to the storage directory
$config['storage_path'] = $bob;
// maximum allowed file size in megabytes.
$config['max_filesize'] = 500; // MBytes
// allowed file type
$config['allowed_ext'] = array("gif","jpg","jpeg","png","pdf","txt","doc","docx","csv","xls","xlsx","rtf","zip","7z");
