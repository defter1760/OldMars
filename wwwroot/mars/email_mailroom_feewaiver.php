		  ...
		  <td width="20" bgcolor="#ffffff" >&nbsp;</td>
			<td bgcolor="#ffffff"><table width="100%" border="0"  cellpadding="14">
			  <tr>
				...
				<p>Please mail out the attached Fee Waiver packet today. <br /><br />
				Mailing address:<br />
				'.$FirstName.' '.$LastName.'
				<br />
				'.$Street1.', '.$Street2.'<br />
...
try {
  ...
  $mail->AddReplyTo('macyslawsuit@initiativelegal.com', 'Macy\'s Lawsuit');
  $mail->Subject = 'Need to mail Fee Waiver packet! - '.$LastName.', '.$FirstName.' - '.$uniqueid;
...
$query = "IF EXISTS (SELECT uniqueid from status WHERE uniqueid='$uniqueid') UPDATE status set feewaivertomailroom='Yes',feewaivertomailroomdate='$dateNOW' WHERE status.uniqueid='$uniqueid'";
