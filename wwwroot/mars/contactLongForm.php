...
echo "<table class='clientProfileTable clear' cellspacing='2' cellpadding='4' border='0'>";
	formstart("contactLongForm.php?uniqueid=".$uniqueid);
	echo "<tr>";
		echo "<td valign='top'>";
			textfieldmake('First Name',$FirstName,'25','FirstName');
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake('Last Name',$LastName,'25','LastName');
		echo "</td>";
		echo "<td valign='top'>";
	...
	echo "<tr>";
		echo "<td valign='top'>";
			textfieldmake('Phone 1',$phone1,'25','phone1');
		echo "</td>";
		echo "<td valign='top'>";
			if (isset($phone2))
			{
				textfieldmake('Phone 2',$phone2,'25','phone2');
			}
			else
			{
				textfieldmake('Phone 2','','25','phone2');
			}
		echo "</td>";
		echo "<td valign='top'>";
			if (isset($fax))
			{
				textfieldmake('Fax',$fax,'25','fax');
			}
			else
			{
				textfieldmake('Fax','','25','fax');
			}
		echo "</td>";
		echo "<td>&nbsp;</td>";
	echo "</tr>";
	echo "<tr>";
		echo "<td valign='top'>";
			textfieldmake(' Street 1',$Street1,'25','Street1');
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake(' Street 2',$Street2,'25','Street2');
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake(' City',$City,'25','City');
		echo "</td>";
	echo "</tr>";
	echo "<tr>";
		echo "<td valign='top'>";
			#textfieldmake(' State',$State,'25','State');
			            echo "State<br>";
		...
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake(' Zipcode',$Zipcode,'25','Zipcode');
		echo "</td>";
		echo "<td valign='top'>";
			if (empty($agentlname))
			{
			...
			{
				textfieldmakenoupdate(' Case Attorney',$agentlname,'25');
			}
		echo "</td>";
		echo "<td>&nbsp;</td>";
	echo "</tr>";
