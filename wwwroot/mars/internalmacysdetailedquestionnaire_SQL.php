  <?PHP
	...
	$ReceiveCommission = $row['ReceiveCommission']; 
	$ReceiveCommissionExplain = $row['ReceiveCommissionExplain']; 
	$DeductCommission = $row['DeductCommission']; 
	$DeductCommissionExplain = $row['DeductCommissionExplain']; 
	$DeductPayCheck = $row['DeductPayCheck']; 
	$DeductPayCheckExplain = $row['DeductPayCheckExplain']; 	
