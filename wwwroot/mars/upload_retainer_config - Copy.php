...
// --- basic ---
// title of your w2box
$config['w2box_title'] = "FILES";
// path to the storage directory

$config['storage_path'] = "\\\\10.129.3.21\\MassAction\\".$brand."\\".$LastName.", ".$FirstName." - ".$uniqueid."\\Retainer\\";
// maximum allowed file size in megabytes.
$config['max_filesize'] = "500"; // MBytes
// allowed file type
#$config['allowed_ext'] = array("gif","jpg","jpeg","png","pdf","txt","doc","rtf","zip","7z","mp3");
$config['allowed_ext'] = array("gif","jpg","jpeg","pdf","txt","doc","rtf","docx");
