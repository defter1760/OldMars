    ...
    <div id="header">
        ...
        <div id="topLinks">
            <?PHP
				...
				echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/mgmt.php'>Search</a>";
				#echo '<a href="javascript: void(0)" onclick="popup(';
					...
					echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/retainerAcceptRejectMgmt.php'>Review AC Agreements</a>";
