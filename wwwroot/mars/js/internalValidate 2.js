  ...
  function validateForm() {
	   ...
	   if (document.getElementById('first_3').value == "") {
		...
		else if (!document.getElementById('input_21_0').checked && document.getElementById('checkedinput_21_1').checked&& !document.getElementById('input_21_1').checked){
                alert( "Did you ever work at a Macy's retail store?" );	
   				document.getElementById('input_21_1').focus();		
				return false;	
            }
		else if (document.getElementById('input_21_0').checked &&document.getElementById('checkedinput_21_1').checked){
		...
		if(document.getElementById('input_20_1').checked && document.getElementById('input_21_1').checked){
			 ...
			 && document.getElementById('input_21_1').checked ){		
			...
			else if (document.getElementById('input_21_1').checked && document.getElementById('input_21_1').checked){
	...
	function hideExp(){
		...
		document.getElementById('input_20_0').value="";
		document.getElementById('input_20_1').value="";
		...
		document.getElementById('input_16_0').value="";
		document.getElementById('input_16_1').value="";
		document.getElementById('input_16_2').value="";
		document.getElementById('input_16_3').value="";
		document.getElementById('input_16_4').value="";
		document.getElementById('input_16_5').value="";
		...
		document.getElementById('input_27_1').value="";
		document.getElementById("id_28").style.display="none";
		document.getElementById('input_28_0').value="";
		document.getElementById('input_28_1').value="";
