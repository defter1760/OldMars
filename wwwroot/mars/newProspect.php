            ...
            <li>
				<?php
					echo "<table class='topTable clear' width='725px' cellspacing='2' cellpadding='2' align='left' >";
						echo "<tr >";
							echo "<td colspan='4'>";
								echo "Are you represented by another attorney in an action against Macy's? <input type='radio' name='notqualified_retained' value='Yes'  id='notqualified_retained_0' onClick='hideExp();'/>Yes<input type='radio' name='notqualified_retained'  id='notqualified_retained_1' value='No' onClick='showExp();'/>No<br><br><strong>WARNING:</strong>
...
echo "Attorney's Name: <input type='text' size='30' value='' name='attName' id='attName'/>";
echo "</td>";
echo "<td width='400px'>";
echo "Phone Number: <input type='text' size='30' value='' name='firmPhone' id='firmPhone'/>";
echo "</td>";
echo "</tr>";
echo "<tr id='attField2' >";
echo "<td valign='top' width='400px'>";
echo "Firm Name: <input type='text' size='30' value='' name='firmName' id='firmName'/>";
echo "</td>";
echo "<td width='400px'>";
echo "City: <input type='text' size='30' value='' name='firmCity' id='firmCity'/>";
echo "</td>";
echo "</tr>";
					echo "</table>";
                ?>
            ...
            <li class="form-line" id="id_6">
              ...
              <li class="form-line" id="id_12">
                ...
                <div id="cid_12" class="form-input">
                    <span class="form-sub-label-container">
                        <input class="form-textbox"  name="Fax" id="input_fax" size="12">
            ...
            <li class="form-line" id="id_330">
                ...
                <div id="cid_330" class="form-input">
                    <input type="text" id="input_4_birthday" name="Birthday" size="30" />
...
//						echo "<tr >";
//							echo "<td>";
//								echo "<p><i>Those are all the questions I have for you today. I encourage you to visit our website at www.macyslawsuit.com to find out more about this case and our law firm. We are currently representing other current and former employees of Macy's for potential wage and hour claims, and are very familiar with this type of litigation. If you have any questions about this case in the future, please call us at 1.888.792.2293, Monday through Friday, or you can visit our website at www.macyslawsuit.com.</i></p>";
//							echo "</td>";
//						echo "</tr>";
//						echo "<tr >";
//							echo "<td>";
...
//                 echo '<textarea id="additionalInfo" class="form-textarea" name="additionalInfo" cols="40" rows="6" /></textarea>';
//						echo "</td>";
//						echo "</tr>";
//						echo "<tr >";
//							echo "<td>";
