...
$query = "IF EXISTS (SELECT uniqueid from status WHERE status.uniqueid='$uniqueid') UPDATE status set authtomailroom='Yes',authtomailroomdate='$date' WHERE status.uniqueid='$uniqueid'";
