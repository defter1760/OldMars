...
echo "<h6 class='clear' style='width: 650px;'>Send Packet</h6>";
...
if (isset($authformsent2))
{
	...
	{
		echo "<tr><td>";
		echo "Authorization for Release sent on ".$authformsentdate2.".";
		echo "</td></tr>";
...
echo "<table class='clientProfileTable' cellspacing='6' cellpadding='2' align='left' border='0'>";
	...
	echo "<tr>";
		...
		echo "<td style='text-align: center;'>";
			checkboxmake2('Auth2','Auth2','Authorization to Release','');
		echo "</td>";
