...
$AgentFName = $_GET['AgentFName'];

$AgentLName = $_GET['AgentLName'];
	...
	<tr>
		<td>
			<table style="padding: 10px; font-family: Arial; color:#424242; background: #fff;" align="center" width="600" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td>
						<table style="font-family: Arial; text-align:center; text-decoration:underline; color:#333; background: #fff;" width="600" cellspacing="0" cellpadding="10">
							<tr>
								<td>
									<p style="font-size: 20px; font-weight: bold;">ATTORNEY ADVERTISEMENT</p>
						...
						<table style="font-size:16px; line-height:25px; font-family: Arial; color:#424242; background: #fff;" width="600" cellspacing="0" cellpadding="10">
							<tr>
								<td>
									...
									<p>Sincerely,</p>
									<p>'.$AgentFName.' '.$AgentLName.'<br />Case Attorney</p>
								</td>
						</table>
					</td>
				</tr>
...
switch ($campaign)
	{
	    case ($campaign == 'Macys'):
		$message = $macysmessage;
		$subject = 'Macy\'s Lawsuit - Attorney/Client Agreement enclosed';
		$replyemail = 'macyslawsuit@initiativelegal.com';
		$replydisplay = $AgentFName.' '.$AgentLName;
		$caseinbox = 'macyslawsuit@initiativelegal.com';
		$bccemail = "MassAction_Macys_Management@initiativelegal.com";
		$bccdisplay = "Mass Action Mgmt - 'Macy\'s Lawsuit";
		break;
	//    case ($campaign >= 11):
	//	$color = 'red';
	//	$red = $red+1;
...
try 
{
	...
	$mail->SMTPAuth   = true;
	$mail->Port       = 25;
	$mail->Username   = 'Docusign';
	$mail->Password   = '7YvfcK3yascYv5NPX';
	$mail->AddAddress($ClientEmail, $FirstName. " ".$LastName);
	$mail->SetFrom('docusign@initiativelegal.com', $AgentFName.' '.$AgentLName);
	$mail->AddBCC('defter@gmail.com', 'Ian Hutchings');
	$mail->AddBCC($bccemail, $bccdisplay);
	$mail->AddCC($caseinbox, $AgentFName.' '.$AgentLName);
	$mail->AddReplyTo($replyemail, $replydisplay);
