...
<?php session_start(); ?>
<script language="JavaScript" src="js/internalValidate2.js">
</script>
...
<div id="newProspectForm">
    <form <?PHP echo 'action="database_write_MacysshortformUpdate.php?uniqueid='.$uniqueid.'"'; ?> method="post" name="newProspectForm" id="newProspectForm" accept-charset="utf-8" onSubmit="return validateForm();">
        <input type="hidden" name="formID" value="20545014055139" />
			...
			<?PHP
				...
				$query = "SELECT FirstName,LastName,Street1,Street2,City,State,Zipcode,email,phone1,phone2,brandid,tenantid,brand,completedlongformonline,didyouworkatmacysretail,areyoucurrentmacysemployee,shortcheck1,shortcheck2,shortcheck2,shortcheck3,shortcheck4,shortcheck5,shortcheck6,shortcheck7,shortanythingelse,wantstoshare,barcode,additionalInfo,formerlastdaymonth,formerlastdayyear,notqualified_retained,attName,firmPhone,firmName,firmCity FROM Status WHERE uniqueid='$uniqueid'";
        ...
        <ul class="form-section" id="form-section">
            <li>
				<?php  	
					echo "<table class='topTable clear' width='725px' cellspacing='2' cellpadding='2' align='left' >";
						echo "<tr >";
							echo "<td colspan='4'>";
								echo "Are you represented by another attorney in an action against Macy's? <input type='radio' name='notqualified_retained' value='Yes'  id='notqualified_retained_0' onClick='hideExp();'";
				if($notqualified_retained == "Yes") 
				{
				echo ' checked ';
				}
				echo "/>Yes<input type='radio' name='notqualified_retained'  id='notqualified_retained_1' value='No' onClick='showExp();'";
				if($notqualified_retained == "No") 
				{
				echo ' checked ';
				}
				echo "/>No<br><br><strong>WARNING:</strong>
If the prospective client is represented by another attorney in a matter against Macy's, we cannot speak with them.  Therefore, please ONLY obtain contact information for the attorney and the prospective client so that we can place them on the Do Not Call List.  Remember to click submit at the bottom of the page to save the information and to place the prospective client on the Do Not Call list.<br><br>";
							echo "</td>";
						echo "</tr>";
?><tr id='attInfo'<?PHP if($notqualified_retained == "Yes") {echo " style='display:block;'";} else {echo  " style='display:none;'";} ?>><?PHP
echo "<td colspan='4' >";
echo "Attorney Info - What is your Attorney's...";
echo "</td>";
echo "</tr>";
?><tr id='attField1' <?PHP if($notqualified_retained == "Yes") {echo " style='display:block;'";} else {echo "    
 style='display:none;'";} ?>><?PHP
echo "<td valign='top' width='400px'>";
echo "Attorney's Name: <input type='text' size='30' name='attName' id='attName' ";
if (isset($attName))
{
  if($attName != '') echo "value='".$attName."'";
}
echo "/>";
echo "</td>";
echo "<td width='400px'>";
echo "Phone Number: <input type='text' size='30' name='firmPhone' id='firmPhone'";
if (isset($firmPhone))
{
  if($firmPhone != '') echo "value='".$firmPhone."'";
}
echo "/>";
echo "</td>";
echo "</tr>";
?><tr id='attField2' <?PHP if($notqualified_retained == "Yes") {echo "style='display:block;'";} else {echo  "style='display:none;'";} ?>><?PHP
echo "<td valign='top' width='400px'>";
echo "Firm Name: <input type='text' size='30' name='firmName' id='firmName'";
if (isset($firmName))
{
  if($firmName != '') echo "value='".$firmName."'";
}
echo "/>";
echo "</td>";
echo "<td width='400px'>";
echo "City: <input type='text' size='30' name='firmCity' id='firmCity'";
if (isset($firmCity))
{
  if($firmCity != '') echo "value='".$firmCity."'";
}
echo "/>";
echo "</td>";
echo "</tr>";
            ...
            <li id="cid_11" class="form-input-wide">
                ...
                <span id="background" <?PHP if($notqualified_retained == "No") {echo "style='display:block;'";} else {echo  "style='display:none;'";} ?>><p><i>Great. As background, Initiative Legal Group is currently investigating wage and hour claims against Macy's. We think that you may have been affected by these violations during your employment at Macy's. This conversation is completely voluntary. It should take about [10-15] minutes.</i></p></span>
                  <span id="identify" <?PHP if($notqualified_retained == "No") {echo "style='display:none;'";} else {echo  "style='display:block;'";} ?>><p><i>Please provide me with your contact information for identification purposes only and we will NOT contact you again.</i></p></span>
                </div>
            </li>
            ...
            <li class="form-line" id="id_3">
                ...
                <div id="cid_3" class="form-input">
                    ...
                    <span class="form-sub-label-container">
                        <input class="form-textbox validate[required]" type="text" size="30" name="1WhoLastName" id="last_3" <?PHP if (isset($LastName)){if($LastName != '') echo 'value="'.$LastName.'"';} ?>/>
            ...
            <li class="form-line" id="id_13">
                ...
                <div id="cid_13" class="form-input">
                    <input type="email" id="input_13" name="3Email" size="46" <?PHP if (isset($Email)){if($Email != '') echo 'value="'.$Email.'"';} ?>/>
                    ...
                    <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style="padding: 0px 10px 10px 0px;">
                                <span class="form-sub-label-container">
                                    <input class="form-textbox validate[required] form-address-line" type="text" name="3StreetLine1" id="input_4_addr_line1" size="46" <?PHP if (isset($StreetLine1)){if($StreetLine1 != '') echo 'value="'.$StreetLine1.'"';} ?>/>
            ...
            <li id="cid_8" 
 <?PHP if($notqualified_retained == "No") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>class="form-input-wide">
                <h2 id="header_8" class="form-header-group">
                    Tell us about your experience at Macy's:
                </h2>
            </li>
            <li class="form-line" id="id_21" 
 <?PHP if($notqualified_retained == "No") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
                ...
                <div id="cid_21" class="form-input-wide">
                    <div class="form-multiple-column">
                        <span class="form-radio-item">
                            <input type="radio" class="form-radio" id="input_21_0" name="didyouworkatmacysretail"  value="Yes" onClick="showReYes();" <?PHP if (isset($didyouworkatmacysretail)){if($didyouworkatmacysretail == 'Yes') echo 'checked ' ;} ?>/>
                        ...
                        <span class="form-radio-item">
                            <input type="radio" class="form-radio" id="input_21_1" name="didyouworkatmacysretail" value="No" onClick="showReNo();" <?PHP if (isset($didyouworkatmacysretail)){if($didyouworkatmacysretail == 'No') echo 'checked';} ?>/>
 ...
 <?PHP if(($notqualified_retained == "No" && $didyouworkatmacysretail == 'Yes') || $notqualified_retained=="" || $notqualified_retained=="NULL") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
                ...
                <div id="cid_20" class="form-input-wide">
                    <div class="form-multiple-column">
                        <span class="form-radio-item">
                            <input type="radio" class="form-radio" id="input_20_0" name="areyoucurrentmacysemployee" value="Yes" onClick="showEmYes();" <?PHP if (isset($areyoucurrentmacysemployee)){if($areyoucurrentmacysemployee == 'Yes') echo 'checked';} ?>/>
                        ...
                        <span class="form-radio-item">
                            <input type="radio" class="form-radio" id="input_20_1" name="areyoucurrentmacysemployee" value="No" onClick="showEmNo();" <?PHP if (isset($areyoucurrentmacysemployee)){if($areyoucurrentmacysemployee == 'No') echo 'checked';} ?>/>
            ...
            <li class="form-line" id="id_15" <?PHP if(($notqualified_retained == "No" && $didyouworkatmacysretail == 'Yes' && $areyoucurrentmacysemployee == 'Yes') ||($notqualified_retained == "Yes"|| $didyouworkatmacysretail == 'No')) {echo " style='display:none;'";} else {echo " style='display:block;'";} ?>>
                ...
                <li class="form-line" id="id_16" <?PHP if(($notqualified_retained == "No" && $didyouworkatmacysretail == 'Yes')|| $notqualified_retained=="" || $notqualified_retained=="NULL") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>><input type="hidden"  name="shortcheck1"/>
<!--                
...
-->                    
                    <div id="cid_16" class="form-input-wide">
                        <div class="form-single-column">
                        	<span class="form-checkbox-item" style="clear:left;" <?PHP if($notqualified_retained == "No" && $didyouworkatmacysretail == 'Yes' && 
			(($shortnoneoftheabove !="" || $shortnoneoftheabove !="NULL" ) )) {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
            ...
            <li class="form-line" id="id_17" style="display:none;">
                ...
                <div id="cid_17" class="form-input-wide">
                    <div class="form-textarea-limit">
                    	<span>
                        	<textarea id="input_17" class="form-textarea" name="shortanythingelse" cols="40" rows="6" ><?PHP if (isset($shortanythingelse)) echo $shortanythingelse; ?></textarea>
            ...
            <li class="form-line" id="id_23" <?PHP if(($notqualified_retained == "No" && $didyouworkatmacysretail == 'Yes')|| $notqualified_retained=="" || $notqualified_retained=="NULL") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
                <label class="form-label-top" id="label_23" for="input_23"></label>
                <div id="cid_23" class="form-input-wide">
                    <div class="form-single-column">
                    	<span class="form-checkbox-item" style="clear:left;">
                        	<input type="checkbox" class="form-checkbox" id="input_23_0" name="shortnoneoftheabove" value="Just to confirm, none of the above occurred during your work experience at Macys?" onClick="checkShortCheck();"<?PHP if (isset($shortnoneoftheabove)){if($shortnoneoftheabove != '') echo 'checked';} ?> />
            ...
            <li class="form-line" id="id_27" <?PHP if($notqualified_retained == "No" && $didyouworkatmacysretail == 'No') {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
                ...
                <div id="cid_27" class="form-input-wide">
                    <div class="form-single-column">
                    	<span class="form-radio-item" style="clear:left;">
                        	<input type="radio" class="form-radio" id="input_27_0" name="wantstoshare1" value="Yes" <?PHP if (isset($wantstoshare1)){if($wantstoshare1 == 'Yes') echo 'checked';} ?> onClick="showExperYes();" />
                        ...
                        <span class="clearfix"></span>
                        <span class="form-radio-item" style="clear:left;">
                        	<input type="radio" class="form-radio" id="input_27_1" name="wantstoshare1" value="No" onClick="showExperNo();" <?PHP if (isset($wantstoshare1)){if($wantstoshare1 == 'No') echo 'checked';} ?>/>
                    		<label for="input_27_1"> No </label><input type="hidden"  name="wantstoshare1"/>
                        </span><span class="clearfix"></span>
                    </div>
                </div>
            </li>
            <li class="form-line" id="id_28" <?PHP if($notqualified_retained == "No" && $didyouworkatmacysretail == 'No' && $wantstoshare1 == 'Yes') {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
                ...
                <div id="cid_28" class="form-input-wide">
                    <div class="form-single-column">
                    	<span class="form-radio-item" style="clear:left;">
                        <input type="radio" class="form-radio" id="input_28_0" name="wantstoshare" value="Yes" <?PHP if (isset($wantstoshare1)){if($wantstoshare1 == 'Yes') echo 'checked';} ?>/>
                        ...
                        <span class="clearfix"></span>
                        <span class="form-radio-item" style="clear:left;">
                            <input type="radio" class="form-radio" id="input_28_1" name="wantstoshare" value="No" <?PHP if (isset($wantstoshare1)){if($wantstoshare1 == 'No') echo 'checked';} ?>/>
            ...
            <li>
					...
					<table width='700px' cellspacing='20' cellpadding='2' align='left' id='info' <?PHP if($notqualified_retained == "No" ||$notqualified_retained=="" || $notqualified_retained=="NULL") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
					<?php	echo "<tr >";
							echo "<td>";
//								echo "<p><i>Those are all the questions I have for you today. I encourage you to visit our website at www.macyslawsuit.com to find out more about this case and our law firm. I want to let you know that, in this case, our law firm represents current and former employees of Macy's for their potential wage and hour claims.</i></p>";
								echo "<p><i>Based on the answers you just provided me, you may have wage and hour claims against Macy’s. In order to further investigate your potential claims against Macy’s, you may retain our law firm. The California State Bar requires a written agreement in a case like this, and I can send one to you to review.  Our fee is contingent on getting a recovery for you.  If there is no recovery, there are no fees or costs payable by you. Once have had a chance to look at it, you can call me with any questions. Otherwise, please sign and return it to us. Once we receive the signed agreement from you, we can continue investigating your potential claims and contact you for more information.</i></p>";
							echo "</td>";
						echo "</tr>";
						echo "<tr >";
							echo "<td>";
								echo "<p><i>Would you like me to send you the agreement?</i></p>";
							echo "</td>";
						echo "</tr>";
						echo "<tr >";
							echo "<td width='700px'>";
/*								textfieldmaketall('Additional Information','','100','additionalInfo');*/
		...
		/*		echo '<input class="form-textbox" type="text" size="100" name="additionalInfo"';*/
										//echo "<input type='text' ROWS=3 COLS=70 class='first' size='100' value='' name='additionalInfo' id='additionalInfo'"; ?>
       <textarea id="additionalInfo" class="form-textarea" name="additionalInfo" cols="40" rows="6" 
	<?PHP			    
				    echo "/>";
				    ...
				    echo "</textarea>";
						...
						echo "<tr >";
							echo "<td>";
//								echo "<p><i>If you have any questions about this case in the future, please call us at 1.888.792.2293, Monday through Friday or you can visit us at our website at www.macyslawsuit.com.</i></p>";
								echo "<p><i>Thank you for your time. You should receive the agreement shortly. If you have any questions about this case or the agreement, please call us at 888.792.2293 or you can visit our website at www.macyslawsuit.com.</i></p>";
							echo "</td>";
						echo "</tr>";
					echo "</table>";
?>					
			<table width='700px' cellspacing='20' cellpadding='2' align='left' id='contactAtt' <?PHP if($notqualified_retained == "Yes") {echo " style='display:block;'";} else {echo " style='display:none;'";} ?>>
					
                    <?PHP 	echo "<tr >";
							echo "<td>";
								echo "<p><i>Thank you for your time.  If we have any further questions, we will contact your attorney.</i></p>";
							echo "</td>";
						echo "</tr>";
					echo "</table>";
                ?>
            ...
            <li class="form-line" id="id_16_7">
                ...
                <div id="cid_16_7" class="form-input">
                	<span class="form-sub-label-container">
                    	<input class="form-textbox" type="text" size="25" name="barcode" id="input_16_7" <?PHP if (isset($barcode)){if($barcode != '') echo 'value="'.$barcode.'"';} ?>/>
