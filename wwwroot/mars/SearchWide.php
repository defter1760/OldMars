...
echo "<FORM NAME ='form2' METHOD ='POST' ACTION='search.php'>";
	...
	echo "<table class='search' border=0 width='600px' cellpadding='1'>";
		echo "<tr>";
			echo "<td></td><td></td><td></td>";
			echo "<td align='center' width='200px' valign='top'>";
...
echo "<table class='table' width='650px' cellpadding='2' cellspacing='2'>";
...
if ($showcalllog == 'Yes')
{
	echo "<table class='table' width='1200px' cellpadding='2' cellspacing='2'>";
		echo "<tr height='15'>";
	echo "<th width='70'>";
//Uniqueidsort drop down -- start
	echo "<select name='Uniqueidsort'>";
...
if ($row['donotcontact'] == 'Yes')
{
	...
	echo "<td><color=red>" . $row['brand'] . "</td>";
	echo "<td><color=red>" . $row['FirstName'] . "</td>";
	echo "<td><color=red>" . $row['LastName'] . "</td>";
	echo "<td><color=red>" . $row['phone1'] .  "</td>";
	echo "<td><color=red>" . $row['phone2'] . "</td>";
	echo "<td><color=red>";
	if (isset($row['email']))
	{
	...
	echo "</td>";
	echo "<td><color=red>" . $row['Street1'] . "</td>";
	echo "<td><color=red>" . $row['Street2'] . "</td>";
	echo "<td><color=red>" . $row['City'] . "</td>";
	echo "<td><color=red>" . $row['State'] . "</td>";
	echo "<td><color=red>" . $row['Zipcode'] . "</td>";
	echo "<td><color=red>" . $row['agentfname'] . " " . $row['agentlname'] . "</td>";
	echo "</tr>";
}
else
{
	...
	echo '">';
	echo $row['uniqueid']."</a></td>";
	echo "<td class='results'>" . $row['brand'] . "</td>";
	echo "<td class='results'>" . $row['FirstName'] . "</td>";
	echo "<td class='results'>" . $row['LastName'] . "</td>";
	echo "<td class='results'>" . $row['phone1'] .  "</td>";
	echo "<td class='results'>" . $row['phone2'] . "</td>";
...
if ($showcalllog == 'Yes')
{
 echo "<table class='table' cellpadding='2' cellspacing='2'>"; 
  echo "<tr>";
  	echo "<th width='100'>Interaction</th>";
	echo "<th width='80%'>Log</th>";
  echo "</tr>";
  echo "<tr>";
  echo "<td>";
