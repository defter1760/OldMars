			...
			echo "<td width='50%' valign='top'>";
				...
				echo "<table class='table' width=100% cellpadding='2' cellspacing='2' valign='top'>";
					echo "<tr class='subtitleRow'><td><h4>These are clients who have not completed the long form over the phone or online</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Long form not complete',
							"longformcompleteonline is null and longformcompleteonphone is null and retaineraccept is not null and agentlname = '$caseattorney' or
							 longformcompleteonline = '' and longformcompleteonphone is null and retaineraccept is not null and agentlname = '$caseattorney' or
							 longformcompleteonline is null and longformcompleteonphone = '' and retaineraccept is not null and agentlname = '$caseattorney' or
							 longformcompleteonline = '' and longformcompleteonphone = '' and retaineraccept is not null and agentlname = '$caseattorney'",
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients who completed the long form over the phone but were not sent Authorization for Settlement</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Long Form completed but Authorization for Settlement not sent ',
							"longformcompleteonphone = 'Yes' and authformsent is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 longformcompleteonphone = 'Yes' and authformsent = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients who completed the long form over the phone but were not sent Authorization for Release</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Long Form completed but Authorization for Release not sent ',
							"longformcompleteonphone = 'Yes' and authformsent2 is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 longformcompleteonphone = 'Yes' and authformsent2 = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
							 $caseattorney,'longformcompleteonphonedate','null');
				echo "</table>";
				...
				echo "<table class='table' width=100% cellpadding='2' cellspacing='2' valign='top'>";
					echo "<tr class='subtitleRow'><td><h4>These are clients who were sent an Authorization for Settlement by mail or email and it has not been returned</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Authorization for Settlement sent but not received ',
							"authformsent is not null and authformsent2 != '' and authformreceived is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 authformsent is not null and authformsent2 != '' and authformreceived = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients whose Authorization for Settlement has been received and has not been reviewed and approved by the Case Attorney</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Authorization for Settlement received and not approved',
							"authformreceived is not null and authformreceived != '' and authaccept is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 authformreceived is not null and authformreceived != '' and authaccept = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
				...
				echo "<table class='table' width=100% cellpadding='2' cellspacing='2' valign='top'>";
					echo "<tr class='subtitleRow'><td><h4>These are clients who were sent an Authorization for Release by mail or email and it has not been returned</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Authorization for Release sent but not received ',
							"authformsent2 is not null and authformsent2 != '' and authformreceived2 is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 authformsent2 is not null and authformsent2 != '' and authformreceived2 = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients whose Authorization for Release has been received and has not been reviewed and approved by the Case Attorney</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Authorization for Release received and not approved',
							"authformreceived2 is not null and authformreceived2 != '' and authaccept2 is null and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney' or
							 authformreceived2 is not null and authformreceived2 != '' and authaccept2 = '' and retaineraccept is not null and retaineraccept != '' and agentlname = '$caseattorney'",
							 $caseattorney,'authformreceiveddate','null');
				...
				echo "<table class='table' width=100% cellpadding='2' cellspacing='2' valign='top'>";
					echo "<tr class='subtitleRow'><td><h4>These are clients who qualify for a Fee Waiver but have not been sent one</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Fee Waivers not sent',
							"feewaiversent is null and feewaiverqualified = 'Yes' and agentlname = '$caseattorney' or
							 feewaiversent = '' and feewaiverqualified = 'Yes' and agentlname = '$caseattorney'",
							 $caseattorney,'feeWaiverQualifiedDate','null');
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients who were sent a Fee Waiver by mail or email and it has not been returned</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Fee Waivers sent and not received',
							"feewaiverqualified = 'Yes' and feewaiversentdate is not null and feewaiversentdate != '' and feewaiverreceived is null and agentlname = '$caseattorney' or
							 feewaiverqualified = 'Yes' and feewaiversentdate is not null and feewaiversentdate != '' and feewaiverreceived !='Yes' and feewaiverreceived != 'Docusigned' and agentlname = '$caseattorney'",
					...
					echo "<tr class='subtitleRow'><td><h4>These are clients whose Fee Waiver has been received and has not been reviewed and approved by the Case Attorney</h4></td><td>&nbsp</td></tr>";
						agingReportRowClient('Fee Waiver received and not approved',
							"feewaiverqualified = 'Yes' and feewaiverreceived is not null and feewaiverreceived != '' and feewaiveraccept is null and agentlname = '$caseattorney' or
							 feewaiverqualified = 'Yes' and feewaiverreceived is not null and feewaiverreceived != '' and feewaiveraccept = '' and agentlname = '$caseattorney'",
