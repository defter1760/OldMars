...
if (isset($_POST['Barcode']))
{
	...
	$query = "IF EXISTS (SELECT FirstName,LastName,barcode,uniqueid,agentlname FROM Status WHERE
        uniqueid='$barcodeprevious' AND TIME IS NOT NULL) UPDATE status set addressisundeliverable='Yes',addressisundeliverabledate='$date',addressisundeliverableweek='$week',addressisundeliverablemonth='$month' where uniqueid='$barcodeprevious' AND TIME IS NOT NULL";
        $sql = sqlsrv_query($conn,$query);
...
//echo "<input type='hidden' name='oldinfo' value='".$addressisundeliverable."'>" ;
//echo "<input type='hidden' name='oldaddressisundeliverable' value='".$addressisundeliverable."'>" ;
//
//if ($_POST['addressisundeliverable'] != $_POST['oldaddressisundeliverable'])
//{
//	if ($_POST['addressisundeliverable'] !== 'Yes')
//	{
