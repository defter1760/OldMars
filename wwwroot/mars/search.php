...
if (isset($noteadd)) 
{
    ...
    $query = "IF EXISTS (SELECT uniqueid from status WHERE status.uniqueid='$noteuniqueid' AND status.brandid='$notebrandid' AND status.tenantid='4') UPDATE status set notelog='$notestring',noteadddate='$date' WHERE status.uniqueid='$noteuniqueid' AND status.brandid='$notebrandid' AND status.tenantid='4'";
...
echo "<FORM NAME ='form2' METHOD ='POST' ACTION='search.php'>";
    echo "<table class='search' border=0 width='100%' cellpadding='1'>";
        echo "<tr>";
            echo "<td align='left' width='200px' class='searchTitle' valign='top'>";
                echo "Client Name:";
            echo "</td><td></td>";
            echo "<td align='left' width='200px' class='searchTitle' valign='top'>";
                echo " Phone Number:";
            echo "</td>";
            echo "<td align='left' width='80px' class='searchTitle' valign='top'>";		
                echo " Email:";
            echo "</td>";
            echo "<td width='60%'>&nbsp;</td>";
        echo "</tr>";
        echo "<tr>";
            ...
            echo "</td>";
            echo "<td valign='top' align='left' width='200px' valign='top'>";
            if (isset($LastName))
            {
            ...
            echo "</td>";
            echo "<td valign='top' width='60%'>&nbsp;</td>";
        echo "</tr>";
        echo "<tr>";
            echo "<td align='left' width='100px' class='searchTitle' valign='top'>";
                echo " Address: ";
            echo "</td>";	
        ...
        echo "<tr>";
            ...
            else
            {
                ...
                echo "</td>";
            echo "<td valign='top' align='left' width='100px'>";
            if (isset($barcode))
            {
            ...
            else
            {
                ...
                echo "<br>";
                echo "<label>Postcard Barcode #</label>";
            echo "</td>";	
            echo "<td valign='top' align='left' width='200px'>";
            if (isset($agentlname))
            {
        ...
        echo "</tr>";
        echo "<tr>";
            echo "<td align='left' class='searchTitle' valign='top'>";
                echo "Show log:";
        ...
        echo "<tr>";
            ...
            echo "<INPUT TYPE = 'Submit' Name = 'Submit1' class='blueBtn' VALUE = 'Search' />";
            echo "</td>";
            echo "</td><td></td><td></td><td></td>";
        echo "</tr>";
        echo "</tr>";
...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] )
{
    if (empty($searchnote))
    {
        ...
        $searchfreeze = $search;
        if (isset($phone1))  $search1 = $search. 'phone1 like \'%'.$phone1.'%\' OR ';
        if (isset($phone1))  $search2 = $searchfreeze. 'phone2 like \'%'.$phone1.'%\'  OR ';
        if (isset($phone1))  $search3 = $searchfreeze. 'phone3 like \'%'.$phone1.'%\'  OR ';
        if (isset($phone1))  $search4 = $searchfreeze. 'phone4 like \'%'.$phone1.'%\'  OR ';
        if (isset($phone1))  $search5 = $searchfreeze. 'phone5 like \'%'.$phone1.'%\'  AND ';
        if (isset($phone1))  $search = $search1.''.$search2.''.$search3.''.$search4.''.$search5;
        #or phone2 like \'%'.$phone1.'%\' or phone3 like \'%'.$phone1.'%\' or phone4 like \'%'.$phone1.'%\' or phone5 like \'%'.$phone1.'%\' or phone6 like \'%'.$phone1.'%\' AND ';
        #if (isset($phone2)) $search = $search. 'phone2 like \'%' . "$phone2" . '%\' AND ';
        
        $search = "$search" . 'Time IS NOT NULL';
        
        $query = "SELECT * FROM
        (SELECT FirstName,LastName,donotcontact,notelog,tenantid,brandid,brand,uniqueid,barcode,agentfname,agentlname,Street1,Street2,City,State,Zipcode,phone1,phone2,notqualified,email,ROW_NUMBER() OVER (ORDER BY LastName)
    ...
    if (isset($sortstring))
    {
        ...
        if (isset($searchnote))
        {
            ...
            $query = "SELECT * FROM
                (SELECT FirstName,LastName,donotcontact,notelog,tenantid,brandid,brand,uniqueid,caseid,agentfname,agentlname,Street1,Street2,City,State,Zipcode,phone1,phone2,notqualified,email,ROW_NUMBER() OVER (ORDER BY LastName)
                as row FROM status where $searchnote
                ) a 
                WHERE row > 0 and row <= 1000 $sort";
            $results = sqlsrv_query($conn,$query);
...
if ($showcalllog == 'No')
{
    ...
    echo "<br>";
    echo "<table class='table' id='searchResults' width='100%' cellpadding='2' cellspacing='2'>";
    echo "<form action='search.php' method='post'>";
        ...
        //Zipcodesort drop down -- START
            ...
            if (isset($Zipcodesort)) 
            {
                if ( $Zipcodesort == "YesAsc" ) 
                {
                    echo "<option value='YesAsc' selected='selected'>Zip Code &uarr;</option>";
                }
                else
                {
                    echo "<option value='YesAsc'>Zip Code &uarr;</option>";
                }
                if ( $Zipcodesort == "YesDesc" ) 
                {
                    echo "<option value='YesDesc' selected='selected'>Zip Code &darr;</option>";
                }
                else
                {
                    echo "<option value='YesDesc'>Zip Code &darr;</option>";
                }
                if ( $Zipcodesort == "No" ) 
                {
                    echo "<option value='No' selected='selected'>Zip Code</option>";
                }
                else
                {
                    echo "<option value='No'>Zip Code</option>";
                }
            }
            else
            {
        ...
        //Agentlastnamesort drop down -- START
            ...
            if (isset($Agentlastnamesort)) 
            {
                ...
                {
                    echo "<option value='YesAsc' selected='selected'>Attorney &uarr;</option>";
                }
                else
                {
                    echo "<option value='YesAsc'>Attorney &uarr;</option>";
                }
                if ( $Agentlastnamesort == "YesDesc" ) 
                {
                    echo "<option value='YesDesc' selected='selected'>Attorney &darr;</option>";
                }
                else
                {
                    echo "<option value='YesDesc'>Attorney &darr;</option>";
                }
                if ( $Agentlastnamesort == "No" ) 
                {
                    echo "<option value='No' selected='selected'>Attorney</option>";
                }
                else
                {
                    echo "<option value='No'>Attorney</option>";
                }
            }
            else
            {
...
if (isset($results))
{
    while($row = sqlsrv_fetch_array($results))
    {
        ...
        echo "<td class='".$tdClass."'>" . $row['brand'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['FirstName'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['LastName'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['phone1'] .  "</td>";
        echo "<td class='".$tdClass."'>" . $row['phone2'] . "</td>";
        echo "<td class='".$tdClass."'>";
        if (isset($row['email']))
        {
        ...
        echo "</td>";
        echo "<td class='".$tdClass."'>" . $row['Street1'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['Street2'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['City'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['State'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['Zipcode'] . "</td>";
        echo "<td class='".$tdClass."'>" . $row['agentfname'] . " " . $row['agentlname'] . "</td>";
        echo "</tr>";
        ...
        if ($showcalllog == 'Yes')
        {
            ...
            echo "<table class='table' cellpadding='2' cellspacing='2'>"; 
                echo "<tr>";
                ...
                echo "<tr>";
                    echo "<td>";
                        echo "Add interaction: <form action='search.php?brandname=";
                        if (isset($brandname))
                        {
                            echo $brandname;
                        }
                        ...
                        if (isset($Zipcode)) echo "<input type='hidden' name='Zip Code' value='" . $Zipcode . "'>";
