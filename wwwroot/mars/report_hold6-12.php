...
//echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/caseattorneyview.php?caseattorney=$caseattorney'>Case Attorney view</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
...
echo "<td>";
    ...
    echo "<td>" . $row3['phone1'] .  "</td>";
    echo "<td>" . $row3['phone2'] . "</td>";
    echo "<td>";
    if (isset($row3['email']))
    {
    ...
    echo "<td>" . $row3['Street2'] . "</td>";
    echo "<td>" . $row3['City'] . "</td>";
    echo "<td>" . $row3['State'] . "</td>";
    echo "<td>" . $row3['Zipcode'] . "</td>";
    echo "<td>" . $row3['agentfname'] . " " . $row3['agentlname'] . "</td>";
    echo "</tr>";
