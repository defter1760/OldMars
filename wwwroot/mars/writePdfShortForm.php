...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['1WhoFirstName']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['1WhoLastName']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['1CallbackNum']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3SecondaryNumber']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3Email']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3StreetLine1']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3StreetLine2']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3HomeCity']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3HomeState']);
		$pdf->Ln();
#	}
...
#	{
		...
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
		$pdf->MultiCell(0,5,$_POST['3Zipcode']);
		$pdf->Ln();
#	}     
if ($_POST['notqualified_retained'] == "No")
{
...
#	{
		$question = "Did you ever miss your meal breaks while working for Macy's?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "Did you ever miss your rest breaks while working for Macy's?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "After you clocked out, were you required to go through a security check?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "Were you paid for all of your overtime work?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "Did you receive your final paycheck within 72 hours or 3 days after your last day of work?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "If you were fired, did you receive your final paycheck on your last day of work?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "During your employment at Macy's, were you paid for all the work that you performed?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
...
#	{
		$question = "Just to confirm, none of the above occurred during your work experience at Macy's?";
		$pdf->SetFont('Times','B',11);
		$pdf->MultiCell(0,5,$question);
		$pdf->SetFont('Times','',11);
                if (isset($_POST['shortcheck7']))
