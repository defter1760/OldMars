...
//	echo "<table id='logo' class='search' border=1 width='600px' cellpadding=1>";
//		echo "<tr>";
//		echo "<td align='left'  class='Mybody' valign='top'>";
...
//echo "</table>";
	...
	echo "<table class='search' border=0 width='600px' cellpadding='1'>";
		echo "<tr>";
			echo "<td align='right' width='100px' class='Mybody' valign='top'>";
				echo "Client Name:";
			echo "</td>";
		...
		echo "</tr>";
	#	echo "</table>";
	#echo "<table width='600px' cellpadding=4>";		
		echo "<tr>";
			echo "<td align='right' width='100px' class='Mybody' valign='top'>";
				echo " Phone:";
			echo "</td>";
	...
	#echo "<table width='600px' cellpadding=4>";	
		...
		echo "</tr>";
	#	echo "</table>";
	#echo "<table width='800px' cellpadding=4>";
		echo "<tr>";
			echo "<td align='right' width='100px' class='Mybody' valign='top'>";
				echo " Address: ";
			echo "</td>";	
	...
	#echo "<table width='800' cellpadding=4>";
		echo "<tr>";
			echo "<td align='right' width='100px' class='Mybody'>";
				#echo " Zipcode:		";
			echo "</td>";	
		...
		echo "</tr>";
	#	echo "</table>";
	#echo "<table width='600' cellpadding=4>";
		echo "<tr>";
			echo "<td align='right' width='100px' class='Mybody' valign='top'>";		
				#echo "Unique ID:";
			echo "</td>";
		...
		echo "</tr>";
	echo "</table>";
	echo "<table id='submitSearch' class='search' border=0 width='600px' cellpadding=4>";
		echo "<tr>";
			#echo "<td align='right' width='400px' class='Mybody' valign='top'>";
			#echo "</td>";
			echo "<td align='left' width='600px' class='Mybody' valign='top'>";
...
#}
	...
	#echo "<table width='600px' cellpadding=4>";
		...
		#echo "</td>";
			...
			echo "<td align='center' width='600px' class='Mybody' valign='top'>";
			#echo "<br>";
...
echo "<table class='table' id='searchResults' width='650px' cellpadding='2' cellspacing='2'>";
