...
$query3 = "SELECT LastName,City,State,Zipcode,Phone1,Phone2,Phone3,Phone4,Phone5,Phone6 FROM status where LastName='".$lname1."' and city='".$city1."' and zipcode='".$zip1."' and imported='8172012'";
...
echo "<br>";
echo $lname1;
echo " ".$city1." = ".$Phone1_2." and now ".$Phone1_3;
echo "<br>";
