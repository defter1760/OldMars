...
<form class="jotform-form" action="internaldatabase_write_MacysFull.php" method="post" enctype="multipart/form-data" name="form_20599278470161" id="20599278470161" accept-charset="utf-8" onSubmit="return validateLongFormDiv1();"> <?PHP #internaldatabase_write_MacysFull.php #posttest.php?>
     ...
     <li class="form-line" id="id_97">
      ...
      >
        <div id="cid_300" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_99" class="form-textarea" name="recentPositionExplain" cols="70" rows="6" value="<?PHP echo $recentPositionExplain;?>"><?PHP echo $recentPositionExplain;?></textarea>
      ...
      <li class="form-line" id="id_114"  <?PHP if($EmployeeHourly == "Other") echo "style='display:block;'"; else echo "style='display:none;'";?>>
	   ...
	   echo "style='display:block;'"; else echo "style='display:none;'";?>>
         <div id="cid_301" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_301" class="form-textarea" name="PaidExplain" cols="70" rows="6" value="<?PHP echo $PaidExplain; ?>"><?PHP echo $PaidExplain; ?></textarea>
...
For each workday that an employer fails to provide an employee with a required 30-minute <u>uninterrupted</u> meal break, the employee is entitled to recover an additional hour of pay at the employee's regular rate.
      ...
      <li class="form-line" id="id_36">
        ...
        <div id="cid_36" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_36" class="form-textarea" name="session3Explain" cols="70" rows="6" value="<?PHP echo $session3Explain;?>"><?PHP echo $session3Explain;?></textarea>
      ...
      <li class="form-line" id="id_304">
        <div id="cid_304" class="form-input-wide">
          <div id="text_304" class="form-html">
            <p>
If the employee is a current employee, please scroll down to the next section. If the employee is a former employee, please proceed with the questions below.
            </p>
          </div>
        </div>
      </li>
...
Under California law, all wages due must be paid at the time of termination of employment, unless the employee quits without giving at least 72 hours notice, in which case the employer must pay the employee's final wages within 72 hours of quitting.   If the employee provides 72 hours notice prior to quitting, all wages due must be paid on the employee's last day of work.
      ...
      <li class="form-line" id="id_68">
        ...
        <div id="cid_68" class="form-input-wide">
          ...
          <label for="input_68_6">I received my final paycheck on my last day of work.</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
      ...
      <li class="form-line" id="id_103">
        ...
        <div id="cid_103" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
              ...
              <label for="input_103_7"> Between $8,733- $9,723 </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">           
...
//				{
					...
					#echo '<button id="input_2" type="submit"  onclick="needToConfirm = false;" class="redBtn">Submit Form</button>';
