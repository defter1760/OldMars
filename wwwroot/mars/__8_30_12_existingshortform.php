            ...
            echo "</select>";
               ...
               <li class="form-line" id="id_330">
                ...
                <div id="cid_330" class="form-input">
                    <input type="text" id="input_4_birthday" name="dateofbirth" size="30" <?PHP if (isset($dateofbirth)){if($dateofbirth != '') echo 'value="'.$dateofbirth.'"';} ?>/>
                    <label class="form-sub-label" for="input_330_birthday" id="sublabel_birthday">
                        Example mm-dd-yyyy
                    </label><br>
                </div>
            </li>
