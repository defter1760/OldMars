...
if (isset($_REQUEST['WhoFirstName'])) $FirstName = $_REQUEST['WhoFirstName'];

if (isset($_REQUEST['WhoLastName'])) $LastName = $_REQUEST['WhoLastName'];

if (isset($_REQUEST['Email'])) $Email = $_REQUEST['Email'];
if (isset($_REQUEST['StreetLine1'])) $StreetLine1 = $_REQUEST['StreetLine1'];
if (isset($_REQUEST['StreetLine2'])) $StreetLine2 = $_REQUEST['StreetLine2'];
...
<form class="jotform-form" action="internaldatabase_write_MacysFull.php" method="post" enctype="multipart/form-data" name="form_20599278470161" id="20599278470161" accept-charset="utf-8"> <?PHP #database_write_MacysFull.php //posttest.php?>
     ...
     <li class="form-line" id="id_97">
        ...
        <div id="cid_97" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;"><input type="hidden" name="recentPosition1"/>
             ...
             <span class="form-radio-item" style="clear:left;">
              ...
              onclick="showPositionExplain();"/>
              <label for="input_97_13">Stockroom</label></span><span class="clearfix"></span>
              <span class="form-radio-item" style="clear:left;">
      ...
      >
        <div id="cid_300" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_99" class="form-textarea" name="recentPositionExplain" cols="70" rows="6" value="<?PHP echo $recentPositionExplain;?>"></textarea>
      ...
      <li class="form-line" id="id_12">
        ...
        <div id="cid_12" class="form-input-wide">
          <select class="form-dropdown validate[required]" style="width:280px" id="input_12" name="1LocCity" onchange="whatCity();">
            <option  <?PHP if(($LocCity == "Other") || !in_array($cityName)) echo "selected";?> value="Other"> Other </option>
            <option <?PHP if($LocCity == "Antioch - County East Mall") echo "selected";?> 
            value="Antioch - County East Mall"> Antioch - County East Mal</option>
	...
	<span class="date-separate">&nbsp;/</span>
      ...
      <li class="form-line" id="id_104">
        ...
        <div class="form-textarea-limit"><span>
          <textarea id="input_104" class="form-textarea" name="identifypeople" cols="40" rows="6" value="<?PHP echo $identifypeople; ?>"></textarea>
...
For each workday that an employer fails to provide an employee with a required 30-minute <u>uninterrupted</u> meal break, the employee is entitled to recover an additional hour of pay at the employee's regular rate.
      ...
      <li class="form-line" id="id_28">
        ...
        <div id="cid_28" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
			  ...
			  <?PHP if($Cat1MealBreakWaived= "YesAlways") echo 'CHECKED';?> value="YesAlways" />
              <label for="input_28_0"> Yes, always</label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
               <input type="radio" class="form-radio validate[required]" id="input_28_1" name="7Cat1MealBreakWaived" 
                <?PHP if($Cat1MealBreakWaived= "YesSometimes") echo 'CHECKED';?> value="YesSometimes" />
			  ...
			  <?PHP if($Cat1MealBreakWaived= "No") echo 'CHECKED';?> value="No"  />
			  ...
			  <?PHP if($Cat1MealBreakWaived= "I dont remember") echo 'CHECKED';?> value="I dont remember"/>
      ...
      <li class="form-line" id="id_29">
        ...
        <div id="cid_29" class="form-input-wide">
		  ...
		  <?PHP if($MealWhenWorkingBetween5and6hours= "No") echo 'Yes';?>  value="Yes"/>
	  ...
	  echo "style='display:block;'"; else echo "style='display:none;'";?>>
          ...
          <div class="form-textarea-limit"><span>
          <textarea id="input_302" class="form-textarea" name="missMealBreakrExplain" cols="70" rows="6" value="<?PHP echo $missMealBreakrExplain; ?>"></textarea>
      ...
      <li class="form-line" id="id_33">
        ...
        <div id="cid_33" class="form-input-wide">
          ...
          <label for="input_33_0"> Yes, always </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_33_1"> Sometimes </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_33_2"> No </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          <input type="radio" class="form-radio validate[required]" id="input_33_3" name="7Cat3DidGetSecondMealBreak" 
          <?PHP if($Cat3DidGetSecondMealBreak == "I dont remember") echo 'CHECKED';?> value="I dont remember" />
      ...
      <li class="form-line" id="id_34">
        ...
        <div id="cid_34" class="form-input-wide">
          ...
          <label for="input_34_0"> Everyday </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_34_1"> Several times a week </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">	
          ...
          <label for="input_34_2"> Once a week </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_34_4">Not applicable</label></span><span class="clearfix"></span>
          </div>
        </div>
      </li>
      <li class="form-line" id="id_35">
        ...
        <div id="cid_35" class="form-input-wide">
		 ...
		 <?PHP if($Cat3Missed2ndMealDidntWaivMealWorkedMoreThan10RecievedExtraHourPay == "Never") echo 'CHECKED';?> value="Never" />
		  ...
		  <?PHP if($Cat3Missed2ndMealDidntWaivMealWorkedMoreThan10RecievedExtraHourPay == "I dont remember") echo 'CHECKED';?> value="I dont remember" />
      ...
      <li class="form-line" id="id_36">
        ...
        <div id="cid_36" class="form-input-wide">
          <div class="form-textarea-limit"><span><textarea id="input_36" class="form-textarea" name="session3Explain" cols="70" rows="6" value="<?PHP echo $session3Explain; ?>"></textarea>
...
With certain exceptions, California law also requires that employers allow employees to take at least a 10-minute <u>uninterrupted</u> rest break for every 4 hours worked. For each day an employer prevents, stops, or interrupts a required 10-minute rest break, the employee is entitled to recover an additional hour of pay at the employee's regular rate of pay.
      ...
      <li class="form-line" id="id_120" <?PHP if($WhyMiss10MinRest == "Other") echo "style='display:block;'"; else echo "style='display:none;'";?>>
	   ...
	   || $WhyMiss10MinRest == "Other") echo "style='display:block;'"; else echo "style='display:none;'";?>>
         <div id="cid_303" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_303" class="form-textarea" name="missRestBreakExplain" cols="70" rows="6" value="<?PHP echo $missRestBreakExplain; ?>"></textarea>
      ...
      <li class="form-line" id="id_42">
        ...
        <div id="cid_42" class="form-input-wide">
          ...
          <label for="input_42_0"> Yes, always </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_42_1"> Sometimes </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_42_2"> No </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          <input type="radio" class="form-radio validate[required]" id="input_42_3" name="8ExtraHourPay" 
          <?PHP if($ExtraHourPay == "I dont remember") echo 'CHECKED';?> value="I dont remember" />
       ...
       <li class="form-line" id="id_203">
        ...
        <div id="cid_203" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_203" class="form-textarea" name="session4Explain" cols="70" rows="6" value=<?PHP echo $session4Explain; ?>></textarea>
    ...
    <select class="form-textbox" id="hour_109" name="bagCheckWaitHour">
       ...
       <li class="form-line" id="id_52">
        ...
        <div id="cid_52" class="form-input-wide">
          ...
          value="Not applicable, I never worked the closing shift." onclick="waitToLeave();"/>
           <label for="input_52_4">Not applicable, I never worked the closing shift.</label></span>
           <span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          </div>
        </div>
      </li> 
      ...
      <li class="form-line" id="id_121" <?PHP if($workOutClock == "Yes") echo "style='display:block;'"; else echo "style='display:none;'";?>>
        ...
        <div id="cid_121" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_121" class="form-textarea" name="afterBeforeClockExplain" cols="70" rows="6" value ="<?PHP echo $afterBeforeClockExplain;?>"></textarea>
...
<label class="form-sub-label" for="minute_57" id="sublabel_offClockMinute">Minute</label>
      ...
      <li class="form-line" id="id_200">
        ...
        <div id="cid_200" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_200" class="form-textarea" name="session5Explain" cols="70" rows="6" value="<?PHP echo $session5Explain;?>"></textarea>
...
Under California law, all wages due must be paid at the time of termination of employment, unless the employee quits without giving at least 72 hours notice, in which case the employer must pay the employee's final wages within 72 hours of quitting.   If the employee provides 72 hours notice prior to quitting, all wages due must be paid on the employee's last day of work.
      ...
      <li class="form-line" id="id_68">
        ...
        <div id="cid_68" class="form-input-wide">
		  ...
		  <?PHP if($HowLongAfterTermRecieveCheckGreaterThan72 == "I received my final paycheck on my last day of work.") echo 'CHECKED';?> v
          alue="I received my final paycheck on my last day of work." />
          <label for="input_68_6">I received my final paycheck on my last day of work.</label></span>
          <span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_68_0"> Between 4 and 7 days </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">		
          ...
          <label for="input_68_1"> Between 1 and 2 weeks </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_68_2"> Between 2 and 4 weeks </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
          ...
          <label for="input_68_3"> More than a month </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
      ...
      <li class="form-line" id="id_96">
       ...
       <li class="form-line" id="id_201">
        ...
        <div id="cid_201" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_201" class="form-textarea" name="session6Explain" cols="70" rows="6" value="<?PHP echo $session6Explain;?>"></textarea>
    ...
    <ul class="form-section" id="session7" style="display:block;">
      ...
      <li class="form-line" id="id_71">
        ...
        <div id="cid_71" class="form-input-wide">
          ...
          value="Yes and I was provided with a seat near my work station, other than a seat in the break room." />
		   ...
		   <?PHP if($DidYourJobRequireStanding == "I dont remember") echo 'CHECKED';?> value="I dont remember" />
      ...
      <li class="form-line" id="id_75">
        ...
        <div id="cid_75" class="form-input-wide">
          ...
          <?PHP if($Consequences == "No") echo 'No';?> value="No" onclick="seatConseq();"/>
       ...
       <li class="form-line" id="id_107" 
        ...
        <div id="cid_107" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_107" class="form-textarea" name="jobListSeated" cols="70" rows="6" value="<?PHP echo $jobListSeated;?>"></textarea>
      ...
      <li class="form-line" id="id_76">
        ...
        <div id="cid_122" class="form-input-wide">
          <div class="form-textarea-limit"><span
          ><textarea id="input_122" class="form-textarea" name="jobSeatedExplain" cols="70" rows="6" value="<?PHP echo $jobSeatedExplain; ?>"></textarea>
      ...
      <li class="form-line" id="id_202">
        ...
        <div id="cid_202" class="form-input-wide">
          <div class="form-textarea-limit"><span>
          <textarea id="input_202" class="form-textarea" name="session7Explain" cols="70" rows="6" value="<?PHP echo $session7Explain; ?>"></textarea>
              <div class="form-textarea-limit-indicator"><span type="Letters" limit="1000" id="input_202-limit">(Maximum characters: 1000)</span>
              </div></span>
          </div>
        </div>
...
/*				function iframemake($page,$uniqueid,$height,$name,$border)
        ...
        <div id="cid_100" class="form-input-wide">
          ...
          <input type="checkbox" class="form-checkbox" id="input_100_0" name="needssase" value="Yes" <?PHP if($needssase == "Yes") echo 'CHECKED';?> />
      ...
      <li class="form-line" id="id_103">
        ...
        <div id="cid_103" class="form-input-wide">
          <div class="form-single-column"><span class="form-radio-item" style="clear:left;">
			  ...
			  <?PHP if($GrossIncome == "2793to3782") echo 'CHECKED';?> value="2793to3782" />
              <label for="input_103_1"> Between $2,793-$3,782 </label></span>
              <span class="clearfix"></span><span class="form-radio-item" style="clear:left;">
              <input type="radio" class="form-radio" id="input_103_2" name="GrossIncome" 
			  <?PHP if($GrossIncome == "3783to4772") echo 'CHECKED';?> value="3783to4772" />
			  ...
			  <?PHP if($GrossIncome == "4773to5762") echo 'CHECKED';?> value="4773to5762" />
			  ...
			  <?PHP if($GrossIncome == "5763to6752") echo 'CHECKED';?> value="5763to6752" />
			  ...
			  <?PHP if($GrossIncome == "6753to7742") echo 'CHECKED';?> value="6753to7742" />
			  ...
			  <?PHP if($GrossIncome == "7743to8732") echo 'CHECKED';?> value="7743to8732" />
              ...
              <label for="input_103_7"> Between $8,733- $9,723 </label></span><span class="clearfix"></span><span class="form-radio-item" style="clear:left;">           <input type="radio" class="form-radio" id="input_103_8" name="GrossIncome" 
