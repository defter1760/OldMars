...
echo "<a style='float: right;' href='http://sqlsrv.domain.initiativelegal.com/mars/reports.php'>Back to reports &raquo;</a>"; 
...
;";
	...
	while($row = sqlsrv_fetch_array($results))
	{
		...
		while($row2 = sqlsrv_fetch_array($results2))
		{
			...
			echo "<table class='tableWrapper' width='100%' cellpadding='2' cellspacing='2' style='background: #eee;'>";
			...
			while($row3 = sqlsrv_fetch_array($results3))
			{
				...
				echo "</td>";
				echo "<td>";				
				echo "<a href='client3.php?uniqueid=".$row3['uniqueid']."'>";
				echo $row3['uniqueid'];
				echo "</a>";
				echo "</td>";
				echo "<td>";
