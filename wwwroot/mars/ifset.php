...
if (isset($_POST['feeWaiverQualifiedDate'])) $feeWaiverQualifiedDate = $_POST['feeWaiverQualifiedDate'];
if (isset($_REQUEST['feeWaiverQualifiedDate'])) $feeWaiverQualifiedDate = $_REQUEST['feeWaiverQualifiedDate'];
if (empty($feeWaiverQualifiedDate)) unset($feeWaiverQualifiedDate);
...
if (isset($_REQUEST['dateofbirth'])) $dateofbirth = $_REQUEST['dateofbirth'];
if (empty($dateofbirth)) unset($dateofbirth);
?>