...
<br><br>
Total website traffic:<br><br>
<img style='-webkit-user-select: none' src='http://dfwms01.initiativelegal.com/pchart213/examples/example.drawBarChart.palette.webhits.php'>
<br><br>
<img style='-webkit-user-select: none' src='http://dfwms01.initiativelegal.com/pchart213/examples/example.drawThreshold.labels.Retainers.php'>
<br><br>
<img style='-webkit-user-select: none' src='http://dfwms01.initiativelegal.com/pchart213/examples/example.drawThreshold.labels.WebHitsShortFormsRetainers.php'>
";        
...
try 
{
	...
	$mail->AddAddress('ihutchings@initiativelegal.com','Ian Hutchings');
        ...
        $mail->AddAddress('PNg@initiativelegal.com','Pamela Ng');        
        ...
        $mail->AddAddress('GSavoy@initiativelegal.com','Grant Savoy');
