...
If the prospective client is represented by another attorney in a matter against Macy's, we cannot speak with them.  Therefore, please ONLY obtain contact information for the attorney and the prospective client so that we can place them on the Do Not Call List.  Remember to click submit at the bottom of the page to save the information and to place the prospective client on the Do Not Call list.<br><br>";
						...
						echo "</tr>";
echo "<tr >";
echo "<td colspan='4' id='attInfo'>";
echo "Attorney Info - What is your Attorney's...";
echo "</td>";
echo "</tr>";
echo "<tr id='attField1' >";
...
echo "</tr>";
            ...
            <li id="cid_11" class="form-input-wide">
                ...
                <span id="background" style="display:block;"><p><i>Great. As background, Initiative Legal Group is currently investigating wage and hour claims against Macy's. We think that you may have been affected by these violations during your employment at Macy's. This conversation is completely voluntary. It should take about [10-15] minutes.</i></p></span>
                  <span id="identify" style="display:none;"><p><i>Please provide me with your contact information for identification purposes only and we will NOT contact you again.</i></p></span>
                </div>
            </li>
...
-->                    
            ...
            <li class="form-line" id="id_23" style="display:block;">
                ...
                <div id="cid_23" class="form-input-wide">
                    <div class="form-single-column">
                    	<span class="form-checkbox-item" style="clear:left;">
                        	<input type="checkbox" class="form-checkbox" id="input_23_0" name="shortnoneoftheabove" value="Just to confirm, none of the above occurred during your work experience at Macys?" <?PHP if (isset($shortnoneoftheabove)){if($shortnoneoftheabove != '') echo 'checked';} ?>/>
