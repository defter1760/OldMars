...
echo "<table class='clientProfileTable clear' width='100%' cellspacing='2' cellpadding='4' align='left' >";
	...
	echo "<td valign='top' width='215px'>";
...
//		}
	echo "</td>";
	echo "<td valign='top' width='270px'>";
...
echo "<table class='clientProfileTable clear' cellspacing='2' cellpadding='4' border='0'>";
	echo "<tr>";
		echo "<td valign='top'>";
			textfieldmake('First Name',$FirstName,'20','FirstName');
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake('Last Name',$LastName,'20','LastName');
		echo "</td>";
		echo "<td valign='top'>";
		...
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake('Email',$email,'20','email');
		echo "</td>";
		echo "<td>&nbsp;</td>";
	echo "</tr>";
	echo "<tr>";
		echo "<td valign='top'>";
			textfieldmake(' Street 1',$Street1,'20','Street1');
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake(' Street 2',$Street2,'20','Street2');
		echo "</td>";
		echo "<td valign='top'>";
		...
		echo "</td>";
		echo "<td valign='top'>";
			textfieldmake(' Zipcode',$Zipcode,'12','Zipcode');
		echo "</td>";
		echo "<td valign='top'>";
			if (empty($agentlname))
			{
			...
			{
				textfieldmakenoupdate(' Case Attorney',$agentlname,'20');
			}
		echo "</td>";
		echo "<td>&nbsp;</td>";
	echo "</tr>";
