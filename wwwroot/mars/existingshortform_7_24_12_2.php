...
-->                    
            ...
            <li>
					...
					<?php	echo "<tr >";
						...
						echo "<tr >";
							echo "<td>";
								echo "<p><i>Do you have any questions for me?</i></p>";
							echo "</td>";
						echo "</tr>";
						echo "<tr >";
							echo "<td width='700px'>";
/*								textfieldmaketall('Additional Information','','100','additionalInfo');*/
	...
	<?PHP			    
				    ...
				    echo "</textarea>";
						...
						echo "<tr >";
							echo "<td>";
								echo "<p><i>If you have any questions about this case in the future, please call us at 888.792.2293, Monday through Friday or you can visit us at our website at www.macyslawsuit.com.</i></p>";
							echo "</td>";
						echo "</tr>";
					echo "</table>";
					
					echo "<table width='700px' cellspacing='20' cellpadding='2' align='left' id='contactAtt' style='display:none;'>";
						echo "<tr >";
							echo "<td>";
