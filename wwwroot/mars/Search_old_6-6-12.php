...
//echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/reports.php'>Reports</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
//	echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/caseattorneyview.php?caseattorney=$caseattorney' target='_parent'>Case Attorney view</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
//	echo "<a href='http://sqlsrv.domain.initiativelegal.com/mars/search.php?ani='>Search</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
...
//		echo "<div id='newProspectBtnWrapper'>";
//			echo "<div id='newProspectBtn'>";
//				echo '<a class="redBtn" href="javascript: void(0)" onclick="popup(';
	...
	echo "<table class='search' border=0 width='100%' cellpadding='1'>";
		...
		echo "<tr>";
			...
			else
			{
				...
				echo "</td>";
			echo "<td align='left' width='100px' class='Mybody'>";
			if (isset($barcode))
			{
...
//	echo "<td>" . $row['agentfname'] . " " . $row['agentlname'] . "</td>";
//	echo "</tr>";
//
//}
