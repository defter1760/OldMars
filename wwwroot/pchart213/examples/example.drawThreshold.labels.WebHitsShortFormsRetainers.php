...
foreach($datearray as $key => $value)
{
	...
	$currentdate = $value;
		...
		$countarray3[] = $row2['COUNT'];
	    	...
	    	$query3 = "SELECT count(*) as COUNT
		FROM status 
		where onlinecompleteday='$currentdate' and shortFormCompletePhoneDate is null;";            
...
//$myPicture->drawScale($Settings);
 ...
 $myPicture->drawText(35,215,"Short form to web hit trend",array("R"=>255,"G"=>255,"B"=>255,"FontSize"=>20,"Angle"=>90,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
...
$myPicture->drawXThreshold("Tuesday(08-28)",array("ValueIsLabel"=>TRUE,"WriteCaption"=>TRUE,"Caption"=>"10000 Post cards","Alpha"=>70,"Ticks"=>5));
