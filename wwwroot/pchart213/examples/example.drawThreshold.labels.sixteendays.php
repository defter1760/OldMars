...
$value= '2012-01';
	...
	$query = "select COUNT(*) as COUNT from status where retainerRecievedMonth='$value' and retainerRecieved='Docusigned' or retainerRecievedMonth='$value' and retainerRecieved='Yes' and retainerAccepted='Yes';;";	
