...
//////'Bonas'
 ...
 $MyData->addPoints(array($Chang,$Grether,$Lee,$Trejo,$Zak,$Savoy),"Clients");
 $MyData->setAxisName(0,"Clients");
$MyData->addPoints(array("Chang","Grether","Lee","Trejo","Zak","Savoy"),"Attorneys");
 
# $MyData->addPoints(array("Firefox","Chrome","Internet Explorer","Opera","Safari","Mozilla","SeaMonkey","Camino","Lunascape"),"Browsers");
 $MyData->setSerieDescription("Attorneys","Attorneys");
 $MyData->setAbscissa("Attorneys");
 $MyData->setAbscissaName("Attorneys");
