...
$query = "SELECT DISTINCT
	...
	while($row = sqlsrv_fetch_array($results))
	{
                ...
                $datearray[] = $row['retainerSentDate'];

            
            $currentdate = $row['retainerSentDate'];
...
$MyData->addPoints($docusigntarray,"Docusigned");
...
# $MyData->addPoints(array($jan12,$feb12,$mar12,$apr12,$may12,$jun12,$jul12,$aug12,$sep12,$oct12,$nov12,$dec12),"Rcvd");
 $MyData->setAxisName(0,"Outgoing Retainers");
 ...
 $myPicture->drawText(35,115,"Outgoing Retainers",array("R"=>255,"G"=>255,"B"=>255,"FontSize"=>20,"Angle"=>90,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
