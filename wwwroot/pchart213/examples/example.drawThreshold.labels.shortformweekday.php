...
$conn = sqlsrv_connect( $serverName, $connectionInfo );
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Monday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Tuesday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Wednesday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Thursday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Friday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Saturday' and ref like '%after-online-survey%';";	
	...
	$query = "select count(*) as COUNT from hits where ip!='4.59.60.154' and ip!='216.55.20.70' and day='Sunday' and ref like '%after-online-survey%';";
...
# $MyData->addPoints(array($jan12,$feb12,$mar12,$apr12,$may12,$jun12,$jul12,$aug12,$sep12,$oct12,$nov12,$dec12),"Rcvd");
 ...
 $myPicture->drawText(35,115,"Short forms by day",array("R"=>255,"G"=>255,"B"=>255,"FontSize"=>20,"Angle"=>90,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
