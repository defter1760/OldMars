...
<div id="main">
<script src="https://static-interlogyllc.netdna-ssl.com/min/g=jotform?3.0.2741" type="text/javascript"></script>
<script type="text/javascript">
...
<div class="clear"></div>
 ...
 <input type="hidden" name="completedonline" value="Yes" />
  ...
  <input class="docusignbutton brown" name="TwoSigners" id="TwoSigners" type="hidden" value="Create an Envelope with 2 Signers" />
                            <input type="hidden" Name="RecipientName2" value="Macys Lawsuit"><input type="hidden" name="RecipientEmail2" value="macyslawsuit@initiativelegal.com">
</form>
</div>
