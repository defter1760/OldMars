    ...
    <ul class="form-section">
      ...
      <li class="form-line" id="id_20" style="display:none;">
        ...
        <div id="cid_20" class="form-input-wide">
          <div class="form-multiple-column"><span class="form-radio-item"><input type="radio" class="form-radio" id="input_20_0" name="q20_areYou" value="Yes" onClick="showEmYes();" />
              <label for="input_20_0"> Yes </label></span><span class="clearfix"></span><span class="form-radio-item"><input type="radio" class="form-radio" id="input_20_1" name="q20_areYou" value="No" onClick="showEmNo();"/>
