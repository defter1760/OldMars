...
//							echo "</td>";
            ...
            <li id="cid_11" class="form-input-wide">
                <div style="display: block; clear: both;">
                    <p>Great. As background, Initiative Legal Group is currently investigating wage and hour claims against Macys. We think that you may have been affected by these violations during your employment at Macys. This conversation is completely voluntary. It should take about [10-15] minutes.</p>
                </div>
            </li>
