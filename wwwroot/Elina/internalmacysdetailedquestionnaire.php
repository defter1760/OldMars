            ...
            <ul class="form-section">
                ...
                <li class="form-line" id="id_3">
                    ...
                    <div id="cid_3" class="form-input"><span class="form-sub-label-container">
                        ...
                        <?PHP 
                            echo "<input type='text' size='15' name='WhoLastName' id='last_3' value='".$LastName."'/>";
                        ?>
                ...
                <li class="form-line" id="id_6">
                    ...
                    <div id="cid_6" class="form-input">
                        ...
                        <?PHP 
                            echo "<input class='form-textbox' type='tel' name='SecondaryNum' id='input_6_phone' size='8' value='".$phone2."'>";
                        ?>
                ...
                <li class="form-line" id="id_5">
                    ...
                    <div id="cid_5" class="form-input">
                        <?PHP 
                            echo "<input type='email' class='form-textbox validate[required, Email]' id='input_5' name='Email' size='30' value='".$Email."'/>";
                        ?>
                    </div>
                </li>
                <li class="form-line" id="id_55">
                    ...
                    <div id="cid_55" class="form-input">
                        <?PHP 
                            echo "<input type='email' name='Email2' class='form-textbox validate[Email_Confirm]' id='input_5_confirm' style='margin-top:8px;' size='30' value='".$Email."'/>";
                        ?> 
                    </div>
                </li>
                <li class="form-line" id="id_7">
                    ...
                    <div id="cid_7" class="form-input">
                        <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="">
                            <tr>
                                <td colspan="2" style="padding: 0px 10px 10px 0px;">
                                	<span class="form-sub-label-container">
										<?PHP
                                             echo "<input class='form-textbox validate[required] form-address-line' type='text' name='StreetLine1' id='input_7_addr_line1' value='".$StreetLine1."'/>";
                                        ?>
                                    <label class="form-sub-label" for="input_7_addr_line1" id="sublabel_addr_line1"> Street Address </label>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding: 0px 10px 10px 0px;">
                                	<span class="form-sub-label-container">
										<?PHP 
                                            echo "<input class='form-textbox form-address-line' type='text' name='StreetLine2' id='input_7_addr_line2' size='46' value='".$StreetLine2."'/>";
                                        ?>
                                    <label class="form-sub-label" for="input_7_addr_line2" id="sublabel_addr_line2"> Street Address Line 2 </label>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%" style="padding: 0px 10px 10px 0px;">
                                	<span class="form-sub-label-container">
										<?PHP 
                                            echo "<input class='form-textbox validate[required] form-address-city' type='text' name='HomeCity' id='input_7_city' size='21' value='".$HomeCity."'/>";
                                        ?>	      
                                    <label class="form-sub-label" for="input_7_city" id="sublabel_city"> City </label>
                                    </span>
                                </td>
                            ...
                            <tr>
                                <td width="50%" style="padding: 0px 10px 10px 0px;">
                                    <span class="form-sub-label-container">
										<?PHP 
                                            echo "<input class='form-textbox validate[required] form-address-postal' type='text' name='Zipcode' id='input_7_postal' size='10' value='".$Zipcode."'/>";
                                        ?>
                                        <label class="form-sub-label" for="input_7_postal" id="sublabel_postal">Zip Code </label>
                                    </span>
                                </td>
                            </tr>
                        </table>
                ...
                <li class="form-line" id="id_304">
                    <div id="cid_304" class="form-input-wide">
                        <div id="text_304" class="form-html">
                            <p>If the employee is a current employee, please scroll down to the next section. If the employee is a former employee, please proceed with the questions below.</p>
