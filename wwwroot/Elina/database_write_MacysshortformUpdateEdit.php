...
if (isset($_REQUEST['1WhoFirstName']))
{
	...
	$query = "UPDATE status set FirstName'$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
if (isset($_POST['1WhoLastName'])) 
{
	...
	$var = "1WhoLastName";
	$vardata = $wholastname;
	$query = "UPDATE status set LastNamer='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
$callbacknum = $phone1;
	$var = "1CallbackNum";
	$vardata = $callbacknum;
	$query = "UPDATE status set phone1 ='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$query = "UPDATE status set phone2='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3Email";
	$vardata = $email;
	$query = "UPDATE status set email='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3StreetLine1";
	$vardata = $streetline1;
	$query = "UPDATE status set Street1='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3StreetLine2";
	$vardata = $streetline2;
	$query = "UPDATE status set Street2='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3HomeCity";
	$vardata = $homecity;
	$query = "UPDATE status set City='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3HomeState";
	$vardata = $homestate;
	$query = "UPDATE status set State='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
else
{
	...
	$var = "3Zipcode";
	$vardata = $zipcode;
	$query = "UPDATE status set Zipcode='$vardata' WHERE uniqueid='$uniqueid'";
			$results = sqlsrv_query($conn,$query);
...
$shortcheck1 = "";$shortcheck2 = "";$shortcheck3 = "";$shortcheck4 = "";$shortcheck5 = "";$shortcheck6 = "";$shortcheck7 = "";$shortnoneoftheabove="";$didyouworkatmacysretail=""; $wantstoshare1="";$areyoucurrentmacysemployee="";$wantstoshare="";
...
{	$shortcheck5 = $_POST['shortcheck5'];
	$var = "shortcheck5";
	$vardata = $shortcheck5;
	//$query = "IF EXISTS (SELECT * from status WHERE uniqueid='$uniqueid' AND tenantid='4' AND brand='$brand' AND brandid='$brandid') UPDATE status set $var='$vardata' WHERE uniqueid='$uniqueid' AND tenantid='4' AND brand='$brand' AND brandid='$brandid'";
			//$results = sqlsrv_query($conn,$query);

}
	$query = "IF EXISTS (SELECT * from status WHERE uniqueid='$uniqueid' AND tenantid='4' AND brand='$brand' AND brandid='$brandid') UPDATE status set shortcheck5='$shortcheck5' WHERE uniqueid='$uniqueid' AND tenantid='4' AND brand='$brand' AND brandid='$brandid'";
			$results = sqlsrv_query($conn,$query);
...
{	$shortnoneoftheabove = $_POST['shortnoneoftheabove'];	

}
	$query = "UPDATE status set shortcheck1='$shortcheck1', shortcheck2='$shortcheck2', shortcheck3='$shortcheck3', shortcheck4='$shortcheck4', shortcheck6='$shortcheck6', shortcheck7='$shortcheck7', shortnoneoftheabove='$shortnoneoftheabove' WHERE uniqueid='$uniqueid'";
	$results = sqlsrv_query($conn,$query); 
...
#{
	...
	$results = sqlsrv_query($conn,$query);  
#echo $uniqueid."";
	$query = "UPDATE status set didyouworkatmacysretail='$didyouworkatmacysretail', wantstoshare1='$wantstoshare1',wantstoshare='$wantstoshare'areyoucurrentmacysemployee='$areyoucurrentmacysemployee' WHERE uniqueid='$uniqueid'";
	$results = sqlsrv_query($conn,$query);
echo "<iframe scrolling='auto' width='100%' height='";
echo "3000px";
echo "' frameborder='0' style='margin:auto;' src='";
