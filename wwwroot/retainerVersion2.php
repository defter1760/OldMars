...
$query = "SELECT authformreceived,retaineraccept,feewaiverreceived,completedlongformonline,FirstName,LastName,brand,phone1,email,brandid,brand FROM Status WHERE uniqueid='$uniqueid'";
$results = sqlsrv_query($conn,$query);
	...
	$retainerAccepted = $row['retaineraccept']; if (empty($retainerAccepted)) unset($retainerAccepted);
...
function getToken($status, $clientID, $uniqueid, $brandid, $brand, $tenantid) {
    ...
    $urls->OnCancel = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    ...
    $urls->OnException = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    $urls->OnFaxPending = 'https://DFWMS01.initiativelegal.com/thanksemail1.php?uniqueid='.$uniqueid.'&statuslevel=Faxpending';
    $urls->OnIdCheckFailed = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    $urls->OnSessionTimeout = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    $urls->OnTTLExpired = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    $urls->OnViewingComplete = "https://DFWMS01.initiativelegal.com/backtoretainer.php?uniqueid=".$uniqueid;
    if ($_oneSigner) {
...
//if (!isset($retainerAccepted))
{
	...
	//{
	//	if (!empty($_SESSION['embedToken']))
	//	{
	
		# LT changes 4/13/2012, 11:52 AM
		
		//echo "<div id='main'>";
		//echo "<div id='primaryContent'>";
		//echo "<h2>CONFIDENTIAL/WORK PRODUCT PRIVILEGE</h2>";
		//echo "<h2>ATTORNEY-CLIENT AGREEMENT</h2>";
		//echo "<p>Please take your time when reviewing this document. </p>";
		//echo "<p>After you have completed your review, you will be prompted to electronically initial and sign the Agreement by clicking on the �sign here� tabs.  You may choose to use your computer�s mouse to draw your electronic signature on the Agreement.  When drawing your electronic signature, do not worry if the electronic version does not look exactly like your real signature.  All that is required is that you input an original mark that you created on the Agreement.</p>";
		//echo "<p>Once you have inserted your initials and signature, you will be asked to confirm your signing of the Agreement.  By clicking on �confirm� you will submit the Attorney-Client Agreement to our law firm. </p>";
		//
...
echo '<div id="main">';
	echo '<div id="message">';
		...
		echo '<h1>Step Two</h1>';
		echo '<p>We believe that you may have wage and hour claims against Macy\'s, Inc.  In order for us to help you pursue these potential claims against Macy\'s, you may choose to retain Initiative Legal Group to represent you.</p>';
		echo '<p>Please take your time and carefully review the Attorney-Client Agreement below. Note that, by signing this Agreement, you will be retaining our law firm. If you have any questions, please contact us at 888.792.2293.</p>';
		echo '<p class="alreadyRepresented">If you are already represented by an attorney for any claims against Macy\'s, please do not continue.</p>';

//		echo "<table align='center' width='1100px' border='0' cellpadding='0' cellspacing='0'>";
		echo "<table align='center' width='1024px' border='0' cellpadding='0' cellspacing='0'>";
			echo "<tr>";
				echo "<td  height='2600px' align='center' valign='top'>";
			//		echo "<iframe  align='middle' marginheight='5%' width='99%' height='98%' src='";
					echo "<iframe  align='left' valign='top' marginheight='5%' width='99%' height='98%' src='";
