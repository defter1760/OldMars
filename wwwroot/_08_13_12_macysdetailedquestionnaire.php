...
<!--                <p><span class="number">5.</span>  You have documents but you need assistance sending them to our law firm.</p>
                <ul id="mail">
...
<?PHP
			if ($completedlongformonline == 'Yes')
			...
			else
				{
					...
					echo "In order to complete the interview, please click on the SUBMIT button below.<br>";
