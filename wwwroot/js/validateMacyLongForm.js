	...
	function showDiv1(){ 
		...
		document.getElementById('session1').scrollIntoView();
	...
	function showDiv3(){		
	 ...
	 function showDiv5(){		
		...
		document.getElementById('session5').scrollIntoView();
	 }
	 function showDiv6(){		
		document.getElementById('session1').style.display="none";
		document.getElementById('session2').style.display="none";
		...
		document.getElementById('session9').style.display="none";
		document.getElementById('session10').style.display="none";
		window.location.href='#TOP6';
		document.getElementById('session6').scrollIntoView();
	 }
	 function showDiv7(){		
		document.getElementById('session1').style.display="none";
		document.getElementById('session2').style.display="none";
		...
		document.getElementById('session9').style.display="none";
		document.getElementById('session10').style.display="none";
		window.location.href='#TOP7';
		document.getElementById('session7').scrollIntoView();
	 }
	 function showDiv8(){		
		document.getElementById('session1').style.display="none";
		document.getElementById('session2').style.display="none";
		...
		document.getElementById('session9').style.display="none";
		document.getElementById('session10').style.display="none";
		window.location.href='#TOP8';
		document.getElementById('session8').scrollIntoView();
	 }
	 function showDiv9(){		
		document.getElementById('session1').style.display="none";
		document.getElementById('session2').style.display="none";
		...
		document.getElementById('session10').style.display="none";
		window.location.href='#TOP9'
		document.getElementById('session9').scrollIntoView();	
	 }
	 function showDiv10(){		
		document.getElementById('session1').style.display="none";
		document.getElementById('session2').style.display="none";
		...
		document.getElementById('session10').scrollIntoView();
	 }
	 function showPositionExplain(){
	   if (document.getElementById('input_97_0').checked){
			...
			document.getElementById('id_400').style.display="block";
			document.getElementById('id_401').style.display="none";
			document.getElementById('id_402').style.display="none";
			document.getElementById('id_403').style.display="none";
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="none";
			document.getElementById('id_410').style.display="none";
			document.getElementById('id_300').style.display="block";					
			}
	   else if (document.getElementById('input_97_1').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			document.getElementById('id_401').style.display="block";
			document.getElementById('id_402').style.display="none";
			document.getElementById('id_403').style.display="none";
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="none";
		 ...
		 else if (document.getElementById('input_97_2').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			document.getElementById('id_401').style.display="none";
			document.getElementById('id_402').style.display="block";
			document.getElementById('id_403').style.display="none";
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="none";
		...
		else if (document.getElementById('input_97_3').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			document.getElementById('id_401').style.display="none";
			document.getElementById('id_402').style.display="none";
			document.getElementById('id_403').style.display="block";
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="none";
	    ...
	    else if (document.getElementById('input_97_4').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_402').style.display="none";
			document.getElementById('id_403').style.display="none";
			document.getElementById('id_404').style.display="block";
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="none";
	    ...
	    else if (document.getElementById('input_97_5').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_403').style.display="none";
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="block";
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="none";
	    ...
	    else if (document.getElementById('input_97_7').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_404').style.display="none";
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="block";
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="none";
			document.getElementById('id_410').style.display="none";
	    ...
	    else if (document.getElementById('input_97_8').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_405').style.display="none";
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="block";
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="none";
			document.getElementById('id_410').style.display="none";
			document.getElementById('id_300').style.display="block";					
			}
	    else if (document.getElementById('input_97_9').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_406').style.display="none";
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="block";
			document.getElementById('id_409').style.display="none";
			document.getElementById('id_410').style.display="none";
			document.getElementById('id_300').style.display="block";					
			}
		else if (document.getElementById('input_97_10').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_407').style.display="none";
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="block";
			document.getElementById('id_410').style.display="none";
			document.getElementById('id_300').style.display="block";					
			}
		else if (document.getElementById('input_97_13').checked){
			document.getElementById('id_98').style.display="none";
			document.getElementById('id_99').style.display="none";
			document.getElementById('id_106').style.display="none";
			document.getElementById('id_400').style.display="none";
			...
			document.getElementById('id_408').style.display="none";
			document.getElementById('id_409').style.display="none";
			document.getElementById('id_410').style.display="block";
			document.getElementById('id_300').style.display="block";					
			}		
		else if (document.getElementById('input_97_6').checked){
	...
	function validateLongFormDiv2() {
	   var form = document.form_20599278470161;
			...
			&& !document.getElementById('input_97_12').checked && !document.getElementById('input_97_13').checked) {
                ...
                document.getElementById('recentPosition1').focus();
				return false;
            } 
			...
			else if ((document.getElementById('input_12').value == "Other" && document.getElementById('input_13').value=="")|| document.getElementById('input_12').value == "") {
			...
			else if (!document.getElementById('input_130_0').checked && !document.getElementById('input_130_1').checked) {
                alert( "During your employment at Macy's, did you ever receive any commissions?" );
                document.getElementById('recentPosition1').focus();
				return false;
            }
			else if (!document.getElementById('input_132_0').checked && !document.getElementById('input_132_1').checked) {
                alert( "During your employment, did Macy's ever deduct a portion of your commissions from your paycheck?" );
                document.getElementById('recentPosition1').focus();
				return false;
            }
	/*		else if (!document.getElementById('input_134_0').checked && !document.getElementById('input_134_1').checked) {
                alert( "If you were not a commissioned employee, did Macy's ever deduct a portion of your paycheck for any reason other than for tax purposes?" );
                document.getElementById('recentPosition1').focus();
				return false;
            }*/
			...
			document.getElementById('year_19').value=="")) {
                ...
                document.getElementById('month_19').focus();
				return false;
            }
				...
				document.getElementById('identifypeople').focus();
				return false;  
            }   				
			else {
				showDiv3();
	   ...
	   var form = document.form_20599278470161;
			...
			!document.getElementById('input_35_4').checked) {
               alert( "Did you receive an additional hour of pay on those occasions you were unable to take an uninterrupted 30-minute meal break?" );
				...
				document.getElementById('input_36').focus();
				return false;  
            }      				
			else {
				showDiv4();
	...
	function validateLongFormDiv4() {
	   var form = document.form_20599278470161;
	        if (!document.getElementById('input_39_0').checked && !document.getElementById('input_39_1').checked) {
                ...
                document.getElementById('RestEverMissed1').focus();
				return false;
            }
			...
			&& !document.getElementById('input_41_2').checked && !document.getElementById('input_41_3').checked) {
                ...
                form.missRestBreakExplain.value = form.missRestBreakExplain.value.substring(0, 1000);
					alert( "Please explain. (Maximum characters: 1000)!" );
				document.getElementById('input_303').focus();
				return false;  
            }    			
			...
			&& !document.getElementById('input_42_4').checked) {
                ...
                form.session4Explain.value = form.session4Explain.value.substring(0, 1000);
					alert( "Please explain any of your answers.  (Maximum characters: 1000)!" );
				document.getElementById('input_203').focus();
				return false;  
            } 	  	
			else {
				showDiv5();
	...
	function validateLongFormDiv5() {
	   var form = document.form_20599278470161;
			...
			!document.getElementById('input_44_2').checked) {
                ...
                document.getElementById('BagsChecksYesNo1').focus();
				return false;
            }
			...
			document.getElementById('minute_110').value=="00")) {
                ...
                document.getElementById('hour_110').focus();
				return false;
            }
			...
			!document.getElementById('input_93_1').checked){
                ...
                form.afterBeforeClockExplain.value = form.afterBeforeClockExplain.value.substring(0, 1000);
					alert( "Please explain.  (Maximum characters: 1000)!" );
				document.getElementById('input_121').focus();
				return false;  
            }	
			else if(document.getElementById('input_93_0').checked &&
			(document.getElementById('hour_57').value=="00" && document.getElementById('minute_57').value=="00")){
                ...
                document.getElementById('hour_57').focus();
				return false;
				}
                ...
                form.session5Explain.value = form.session5Explain.value.substring(0, 1000);
					alert( "Please explain any of your answers.  (Maximum characters: 1000)!" );
				document.getElementById('input_200').focus();
				return false;  
            }
			else {
				showDiv6();
	...
	function validateLongFormDiv7() {
	   var form = document.form_20599278470161;
			...
			&& !document.getElementById('input_71_2').checked && !document.getElementById('input_71_3').checked) {
                ...
                document.getElementById('DidYourJobRequireStanding1').focus();
				return false;
            }
                ...
                form.jobListSeated.value = form.jobListSeated.value.substring(0, 1000);
					alert( "Please explain. (Maximum characters: 1000)!" );
				document.getElementById('input_107').focus();
				return false;  
            } 
                ...
                form.session7Explain.value = form.session7Explain.value.substring(0, 1000);
					alert( "Please explain any of your answers.  (Maximum characters: 1000)!" );
				document.getElementById('input_202').focus();
				return false;  
            } 
			else {
				showDiv8();
...
/*	   var form = document.form_20599278470161;
	...
	function showReceiveCommExplain(){
		if (document.getElementById('input_130_0').checked){
			document.getElementById('id_131').style.display="block";
		}
		else{
			document.getElementById('id_131').style.display="none";
			document.getElementById('input_131').value="";
			}
		}
	function showDeductCommExplain(){
		if (document.getElementById('input_132_0').checked){
			document.getElementById('id_133').style.display="block";
		}
		else{
			document.getElementById('id_133').style.display="none";
			document.getElementById('input_133').value="";
			}
		}
	function showDeductCheckExplain(){
		if (document.getElementById('input_134_0').checked){
			document.getElementById('id_135').style.display="block";
		}
		else{
			document.getElementById('id_135').style.display="none";
			document.getElementById('input_135').value="";
			}
		}
