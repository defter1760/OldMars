  ...
  function validateForm() {
	   ...
	   var validformat=/^\d{2}\-\d{2}\-\d{4}$/;
        ...
        if (document.getElementById('first_3').value == "") {
			...
			else if (document.getElementById('input_21_0').checked && !document.getElementById('input_20_0').checked && !document.getElementById('input_20_1').checked){            	
				alert( "Are you currently employed at Macy's?" );	
                document.getElementById('input_20_0').focus();
				return false;
				}
			else if(document.getElementById('input_21_0').checked && document.getElementById('input_20_1').checked &&(document.getElementById('month_15').value==""||document.getElementById('year_15').value=="")){
			...
			else if (document.getElementById('input_21_0').checked && !document.getElementById('input_16_1').checked && !document.getElementById('input_16_2').checked 
			...
			else if (document.getElementById('input_21_1').checked && !document.getElementById('input_27_0').checked && !document.getElementById('input_27_1').checked){				
