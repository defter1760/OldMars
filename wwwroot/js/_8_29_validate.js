	   ...
	   var validformat=/^\d{2}\-\d{2}\-\d{4}$/;
        ...
        if (document.getElementById('first_3').value == "") {
			  ...
			  return false;
				...
				if (document.getElementById('defaultReal').value == "" && navigator.appName == 'Microsoft Internet Explorer') {
                alert( "Please enter the CAPTCHA code." );
...
/*			else if (document.getElementById('code2').value == "" && navigator.appName != 'Microsoft Internet Explorer') {
                alert( "Please enter the CAPTCHA code." );
                document.getElementById('code2').focus();
				return false;	
            }
			else if (document.getElementById('defaultReal').value == "" && navigator.appName == 'Microsoft Internet Explorer') {
                alert( "Please enter the CAPTCHA code." );
                document.getElementById('defaultReal').focus();
				return false;	
           }*/
